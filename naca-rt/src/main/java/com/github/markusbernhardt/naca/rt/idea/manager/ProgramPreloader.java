...
public class ProgramPreloader {
  ...
  // private SharedProgramInstanceData tryDeserialize(String
  // csVarDefCatalogueSerilizationPath, String csProgramName)
  // {
  ...
  // private void serialize(String csVarDefCatalogueSerilizationPath, String
  // csProgramName, SharedProgramInstanceData sharedProgramInstanceData)
  // {
  // sharedProgramInstanceData.serialize(csVarDefCatalogueSerilizationPath,
  // csProgramName);
  // }
    ...
    for (int n = 0; n < nNbPrograms; n++) {
      ...
      if (!csProgramName.equalsIgnoreCase("Pub2000Routines")) {
        try {
          ...
          // sharedProgramInstanceData = tryDeserialize(csVarDefCatalogueSerilizationPath,
          // csProgramName);
