...
public class InternalCharBuffer extends CJMapObject {
  ...
  // public int setStringAtWithStringLength(int nAbsoluteStartPosition, String cs,
  // int nStringLength, int nLength)
  // {
  // char c = 0;
  ...
  // public void setSemanticContextValue(String csValue, int
  // nAbsoluteStartPosition)
  // {
  ...
  // public void inheritSemanticContext(InternalCharBuffer bufferSource, int
  // nOffset)
  // {
  ...
  // //int nMaxAbsoluteStartPositionSource = nMinAbsoluteStartPositionSource +
  // nLengthPositionSource - 1;
  ...
  // private Hashtable<Integer, String> m_hashSemantics = null; // Hash table of
  // vars index by name
