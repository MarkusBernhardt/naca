...
import com.github.markusbernhardt.naca.rt.idea.action.ActionCompat;
import com.github.markusbernhardt.naca.rt.idea.action.ActionScenarioList;
...
public class EmulWebRunner extends BaseCloseMBean {
  ...
  void run(String[] args) {
    ...
    if (ms_bPlayAllScenario) {
      ...
      // Log.logCritical("Scneario loop executed in " + sw.getElapsedTimeReset() + "
      // ms");
    ...
    // action.RunClientRequest(session);
    // xmlOutput = session.getXMLOutput() ;
    // XMLUtil.ExportXML(xmlOutput,
    // "D:\\Dev\\NacaRunTime\\idea\\web\\3-rs78m00.xml") ;
    ...
    // xmlOutput = session.getXMLOutput() ;
    // XMLUtil.ExportXML(xmlOutput,
    // "D:\\Dev\\NacaRunTime\\idea\\web\\4-rs78m02.xml") ;
  ...
  protected void buildDynamicMBeanInfo() {
    ...
    // addOperation("Set or reset Enable", getClass(), "setEnable", Boolean.class);
    // //Boolean.TYPE);
