...
import com.github.markusbernhardt.naca.rt.varEx.Dec;
import com.github.markusbernhardt.naca.rt.varEx.VarAndEdit;

public class MathAdd extends MathBase {
  /**
   * @param VarAndEdit
   *          VarAndEdit1: VarAndEditiable to be added Set current object to
   *          VarAndEdit1's numeric value
   */
   ...
   *          VarAndEdit1
   * @param VarAndEdit
   *          VarAndEdit2 Set current object to VarAndEdit1+VarAndEdit2
   *          (VarAndEdit are treated as numeric optionnaly decimals / signed)
   */
   ...
   *          VarAndEdit1
   * @param int
   *          n Set current object to VarAndEdit1+n
   */
   ...
   *          VarAndEdit1
   * @param double
   *          d Set current object to VarAndEdit1+d
   */
   ...
   *          VarAndEdit1
   * @param String
   *          s, will be converted to a number Set current object to VarAndEdit1+s
   */
   ...
   *          VarAndEdit1
   * @param MathBase
   *          mathBase Set current object to VarAndEdit1+mathBase
   */
   ...
   *          mathBase
   * @param int
   *          n Set current object to mathBase+n
   */
   ...
   *          n
   * @param MathBase
   *          mathBase Set current object to mathBase+n
   */
  ...
  /**
   * @param VarAndEdit
   *          VarAndEdit; treated as a number Set current object's value to
   *          current object+VarAndEdit
   */
  ...
  /**
   * @param String
   *          cs; treated as a number Set current object's value to current
   *          object+cs
   */
  ...
  /**
   * @param int
   *          n Set current object's value to current object+n
   */
  ...
  /**
   * @param double
   *          d Set current object's value to current object+d
   */
  ...
  /**
   * @param MathBase
   *          mathBase Set current object's value to current object+mathBase
   */
