 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
package com.github.markusbernhardt.naca.rt.mathSupport;
...
public class MathDivide extends MathBase {
   ...
   *          var1
   * @param Var
   *          var2 Set current object to var1/var2 (var are treated as numeric
   *          optionnaly decimals / signed) if var2 = 0, then an error is set; it
   *          can be tested by chaining .isError() (member of base class MathBase)
   */
   ...
   *          var1
   * @param int
   *          n Set current object to var1/n (var are treated as numeric
   *          optionnaly decimals / signed) if var2 = 0, then an error is set; it
   *          can be tested by chaining .isError() (member of base class MathBase)
   */
   ...
   *          var1
   * @param double
   *          d Set current object to var1/d (var are treated as numeric
   *          optionnaly decimals / signed) if var2 = 0, then an error is set; it
   *          can be tested by chaining .isError() (member of base class MathBase)
   */
   ...
   *          var1
   * @param String
   *          cs; treated as a number Set current object to var1/cs if var2 = 0,
   *          then an error is set; it can be tested by chaining .isError()
   *          (member of base class MathBase)
   */
   ...
   *          var1
   * @param MathBase
   *          mathBase Set current object to var1/mathBase if var2 = 0, then an
   *          error is set; it can be tested by chaining .isError() (member of
   *          base class MathBase)
   */
   ...
   *          mathBase
   * @param Var
   *          var2 Set current object to mathBase/var2 if var2 = 0, then an error
   *          is set; it can be tested by chaining .isError() (member of base
   *          class MathBase)
   */
   ...
   *          mathBase
   * @param int
   *          n Set current object to mathBase/n if var2 = 0, then an error is
   *          set; it can be tested by chaining .isError() (member of base class
   *          MathBase)
   */
   ...
   *          mathBase
   * @param double
   *          d Set current object to mathBase/d if var2 = 0, then an error is
   *          set; it can be tested by chaining .isError() (member of base class
   *          MathBase)
   */
   ...
   *          mathBase
   * @param String
   *          cs, treated as a number Set current object to mathBase/cs if var2 =
   *          0, then an error is set; it can be tested by chaining .isError()
   *          (member of base class MathBase)
   */
   ...
   *          mathBase1
   * @param MathBase
   *          mathBase2 Set current object to mathBase1/mathBase2 if var2 = 0,
   *          then an error is set; it can be tested by chaining .isError()
   *          (member of base class MathBase)
   */
  ...
  /**
   * @param Var
   *          varQuotient: destination variable that will receive the quotient of
   *          the last divide operation, recomputed as an integer divide
   * @param Var
   *          varRest: destination variable that will receive the rest of the last
   *          divide operation, recomputed as an integer divide
   * @return The last division is done again, as an integer one. This to method
   *         must follow immediatly the division to do.
   */
