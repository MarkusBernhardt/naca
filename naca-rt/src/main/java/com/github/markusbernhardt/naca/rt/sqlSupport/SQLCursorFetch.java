...
public class SQLCursorFetch {
  // public SQLCursorFetch(VarBufferPos Working, CSQLConnection SQLConnection,
  // String csQuery)
  // {
  // }
  ...
  // public String getCursorName() // use for updatable cusrot that use Cursor
  // Name
  // {
  // if(m_SQL != null)
  ...
  // PJD ROWID Support:
  /*
   * public ROWID getCurrentRowId() { if(m_sqlItemRowId != null) return
   * m_sqlItemRowId.getRowId(); return null; }
   */

  // PJD ROWID Support:private CSQLIntoItem m_sqlItemRowId = null; // Used for
  // updatable cursor that use RowId
