...
public class MathSubtract extends MathBase {
   ...
   *          var1
   * @param int
   *          n Set current object to var1-n
   */
   ...
   *          n
   * @param VarAndEdit
   *          var1 Set current object to n-var1
   */
   ...
   *          var1
   * @param double
   *          d Set current object to var1-d
   */
   ...
   *          d
   * @param VarAndEdit
   *          var1 Set current object to d-var1
   */
   ...
   *          var1
   * @param String
   *          s, treated as a number Set current object to var1-s
   */
   ...
   * @param VarAndEdit
   *          var1 Set current object to s-var1
   */
   ...
   *          var1
   * @param MathBase
   *          mathBase Set current object to var1-mathBase
   */
   ...
   *          mathBase
   * @param VarAndEdit
   *          var1 Set current object to mathBase-var1
   */
   ...
   *          mathBase
   * @param double
   *          d Set current object to mathBase-d
   */
   ...
   *          mathBase
   * @param String
   *          s Set current object to mathBase-s
   */
   ...
   * @param VarAndEdit
   *          var
   * @return this Set current object to var-current objet
   */
