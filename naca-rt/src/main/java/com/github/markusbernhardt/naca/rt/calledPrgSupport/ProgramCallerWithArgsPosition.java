 ...
 */
package com.github.markusbernhardt.naca.rt.calledPrgSupport;
...
import com.github.markusbernhardt.naca.rt.callPrg.CalledProgramLoader;
import com.github.markusbernhardt.naca.rt.callPrg.CalledResourceManager;
import com.github.markusbernhardt.naca.rt.callPrg.CalledResourceManagerFactory;
import com.github.markusbernhardt.naca.rt.callPrg.CalledSession;
import com.github.markusbernhardt.naca.rt.exceptions.AbortSessionException;
import com.github.markusbernhardt.naca.rt.exceptions.ProgramCallerException;

/**
 *
 * @author Pierre-Jean Ditscheid, Consultas SA
 * @version $Id: ProgramCallerWithArgsPosition.java,v 1.2 2007/09/21 15:11:30
 *          u930bm Exp $
 */
public class ProgramCallerWithArgsPosition extends CalledProgramParamSupportByPosition {
  ...
  public boolean execute() throws ProgramCallerException {
    ...
    try {
      ...
      env.fillEnvConnectionWithAllocatedConnection(m_dbConnection.getDbConnection(), "ExternalConnection", m_dbConnection.getEnvironmentPrefix(),
          bUseStatementCache);
