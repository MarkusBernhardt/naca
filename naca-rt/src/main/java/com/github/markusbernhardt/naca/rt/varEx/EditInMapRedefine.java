...
public class EditInMapRedefine extends Edit {
  ...
  // {
  // Var varChild =
  // (Var)m_bufferPos.getProgramManager().getVarFullName(varDefChild);
  // return varChild;
  // }
  // }
  // return null;
  ...
  public EditInMapRedefine allocOccursedItem(VarDefBuffer varDefItem) {
    ...
    // assertIfFalse(vItem.m_bufferPos.getProgramManager() ==
  ...
  // {
  // String csSimpleName =
  // TempCacheLocator.getTLSTempCache().getProgramManager().getProgramName();
  //
  // StringBuffer sbText = new StringBuffer();
  // sbText.append("In program " + csSimpleName + "\r\n");
  // sbText.append("It will crash\r\n");
  // sbText.append("Could not find The variable getVarDefEditInMapOrigin() for
  // current varDef\r\n");
  // sbText.append("Current varDefId="+m_varDef.getId()+" / varDef
  // solvedId="+m_varDef.getIdSolvedDim()+"\r\n");
  //
  // sbText.append("\r\n");
  //
  // SharedProgramInstanceData sharedProgramInstanceData =
  // SharedProgramInstanceDataCatalog.getSharedProgramInstanceData(csSimpleName);
