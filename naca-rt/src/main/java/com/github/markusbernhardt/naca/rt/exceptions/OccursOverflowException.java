...
public class OccursOverflowException extends NacaRTException {
  ...
  public String getMessage() {
    String cs = "OccursOverflowException: Index " + m_csIndexName + " value requested/Max:" + m_nIndexRequestedBase1 + "/" + m_nIndexMaxValueBase1 + "; VarDef:"
        + m_csVarDefBase; // + "; Stack="+m_csStack;
    return cs;
  }
}
