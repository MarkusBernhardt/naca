...
public class CSQLPreparedStatement extends DbPreparedStatement {
  ...
  public CSQLResultSet executeQueryAndFillInto(SQL sql, int nNbFetch) {
    CSQLResultSet SQLResultSet = executeQuery(sql); // sql.m_sqlStatus, sql.m_arrColSelectType, sql.m_accountingRecordManager,
                                                    // sql.m_hashParam, sql.m_hashValue);
  ...
  public CSQLResultSet executeQuery(SQL sql) // CSQLStatus sqlStatus, ArrayFixDyn<Integer> arrColSelectType,
                                             // AccountingRecordTrans accountingRecordManager, HashMap<String, CSQLItem>
