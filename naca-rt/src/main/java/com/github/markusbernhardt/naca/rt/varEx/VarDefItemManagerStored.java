...
public class VarDefItemManagerStored extends VarDefItemManager {
  ...
  // VarDefBuffer createVarDefItems(ProgramManager programManager, VarDefBase
  // varDefMaster, int x, VarDefBase varDefOccursParent)
  // {
  // VarDefBuffer varDefItem = createAt(programManager, varDefMaster, x,
  // varDefOccursParent);
  ...
  //
  // VarDefBuffer createVarDefItems(ProgramManager programManager, VarDefBase
  // varDefMaster, int x, int y, VarDefBase varDefOccursParent)
  // {
  // int nStorageIndex = getStorageIndex(varDefMaster, y, x);
  // m_aVarDefItems[nStorageIndex] = createAt(programManager, varDefMaster, y, x,
  // varDefOccursParent);
  // return m_aVarDefItems[nStorageIndex];
  // }
  //
  // VarDefBuffer createVarDefItems(ProgramManager programManager, VarDefBase
  // varDefMaster, int x, int y, int z, VarDefBase varDefOccursParent)
  // {
  // int nStorageIndex = getStorageIndex(varDefMaster, z, y, x);
  // m_aVarDefItems[nStorageIndex] = createAt(programManager, varDefMaster, z, y,
  // x, varDefOccursParent);
  // return m_aVarDefItems[nStorageIndex];
  // }

  // private VarDefBuffer createAt(ProgramManager programManager, VarDefBase
  // varDef, int nXBase0, VarDefBase varDefOccursParent)
  // {
  ...
  //
  // VarDefBuffer varDefBuffer = varDef.createCopySingleItem(nAbsStart,
  // String.valueOf(nXBase0+1));
  ...
  // private VarDefBuffer createAt(ProgramManager programManager, VarDefBase
  // varDef, int nYBase0, int nXBase0, VarDefBase varDefOccursParent)
  // {
  // int nNbDim = varDef.getNbDim();
  // if(nNbDim == 2)
  // {
  ...
  //
  //
  // String csIndexes = String.valueOf(nYBase0+1) + "," +
  // String.valueOf(nXBase0+1);
  ...
  // private VarDefBuffer createAt(ProgramManager programManager, VarDefBase
  // varDef, int nZBase0, int nYBase0, int nXBase0, VarDefBase varDefOccursParent)
  // {
  // int nNbDim = varDef.getNbDim();
  // if(nNbDim == 3)
  // {
  ...
  // varDef.getDistanceFromOccursOwner(0);
  //
  // String csIndexes = String.valueOf(nZBase0+1) + "," +
  // String.valueOf(nYBase0+1) + "," + String.valueOf(nXBase0+1);
  // VarDefBuffer varDefBuffer = varDef.createCopySingleItem(n, csIndexes);
  //
  // varDefBuffer.m_varDefParent = varDefOccursParent;
  // if(varDefOccursParent != null)
