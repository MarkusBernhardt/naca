...
public class MathMultiply extends MathBase {
   ...
   *          var1
   * @param String
   *          s, treated as a number Set current object to var1*s (var are treated
   *          as numeric optionnaly decimals / signed)
   */
   ...
   *          var1
   * @param MathBase
   *          mathBase Set current object to var1*mathBase (var are treated as
   *          numeric optionnaly decimals / signed)
   */
   ...
   *          n
   * @param MathBase
   *          mathBase Set current object to n*mathBase
   */
   ...
   *          d
   * @param MathBase
   *          mathBase Set current object to d*mathBase
   */
   ...
   *          mathBase1
   * @param MathBase
   *          mathBase2 Set current object to mathBase1*mathBase2
   */
   ...
   * @param Var
   *          var
   * @return this Set current object to current objet * var
   */
  ...
  /**
   * @param String
   *          s; treated as a number
   * @return this Set current object to current objet * s
   */
   ...
   * @param int
   *          n
   * @return this Set current object to current objet * n
   */
   ...
   * @param double
   *          d
   * @return this Set current object to current objet * d
   */
   ...
   * @param MathBase
   *          mathBase
   * @return this Set current object to current objet * mathBase
   */
