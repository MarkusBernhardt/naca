...
import com.github.markusbernhardt.naca.rt.varEx.SortKeySegmentDefinition;
...
public class BtreeKeyDescription {
  ...
  public void addSegmentDefinition(SortKeySegmentDefinition keySegmentDefinition) {
    ...
    BtreeKeySegment btreeKeySegment = btreeSegmentKeyTypeFactory.make(nKeyPositionInData, m_nKeyPositionInKey, nBufferLength,
        keySegmentDefinition.m_bAscending);
  ...
  void prepare() {
    ...
    for (int n = 0; n < nNbSegments; n++) {
      m_nKeyLength += m_arrKeySegment.get(n)
                                     .getLength();
    }
