...
public class VarDefNumDecSignComp3 extends VarDefNum {
  ...
  private Dec readDecSignComp3(VarBufferPos buffer, int nNbDigitInteger, int nNbDigitDecimal) {
    ...
    // {
    // Dec dec = new Dec(0L, "");
    // long l = internalReadIntSignComp3AsLong(buffer,
    // nNbDigitInteger+nNbDigitDecimal);
    // dec.setLong(l);
    // }
  ...
  public void write(VarBufferPos buffer, BigDecimal bigDecimal) {
    ...
    // Pic9Comp3BufferSupport.setDec(buffer, m_nNbDigitInteger, m_nNbDigitDecimal,
    // m_nTotalSize, 0, true, csDec);
  ...
  public String digits(VarBufferPos buffer) {
    ...
    // cs += s.substring(m_nNbDigitInteger+nOffset,
    // m_nNbDigitInteger+m_nNbDigitDecimal+nOffset);
    // return cs;
