...
public abstract class BaseSession {
  ...
  // bEbcdicFile, boolean bExt, int nLength)
  // {
  // LogicalFileDescriptor fd = new LogicalFileDescriptor(csPath, bEbcdicFile,
  // bExt, nLength);
  // if(m_hashLogicalFileDescriptors == null)
  // m_hashLogicalFileDescriptors = new Hashtable<String,
  // LogicalFileDescriptor>();
