 ...
 * @version $Id: VarDefEncodingConvertibleManager.java,v 1.13 2007/06/09
 *          12:04:22 u930bm Exp $
 */
public class VarDefEncodingConvertibleManager {
  ...
  public void add(int nPosition, int nLength, boolean bConvertOnlyIfBlank, boolean bConvertPrint) {
    ...
    if (ePrevious != null && ePrevious.isConvertOnlyIfBlank() == bConvertOnlyIfBlank && ePrevious.isConvertPrint() == bConvertPrint) {
