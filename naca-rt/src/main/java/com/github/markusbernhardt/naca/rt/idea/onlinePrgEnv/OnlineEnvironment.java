...
import com.github.markusbernhardt.naca.rt.idea.manager.CESMSendMap;
...
public class OnlineEnvironment extends BaseEnvironment {
  ...
  /*
   * m_csLastCommandCode see for info :
   * http://publib.boulder.ibm.com/infocenter/txen/index.jsp?topic=/com.ibm.
   * txseries510.doc/erzhai00148.htm
   */
  ...
  public void recordInput() {
    if (m_docDataRecord == null) {
      ...
      try {
        m_docDataRecord = DocumentBuilderFactory.newInstance()
                                                .newDocumentBuilder()
                                                .newDocument();
      } catch (ParserConfigurationException e) {
        e.printStackTrace();
