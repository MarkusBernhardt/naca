...
public class VarLevel extends CJMapObject {
  ...
  {
    DeclareTypeG declareTypeG = TempCacheLocator.getTLSTempCache()
                                                .getDeclareTypeG();
  ...
  public DeclareTypeX picX(int nLength) {
    DeclareTypeX declareTypeX = TempCacheLocator.getTLSTempCache()
                                                .getDeclareTypeX();
  ...
  private DeclareType9 pic9Define(boolean bSigned, int nNbDigitInteger, int nNbDigitDecimal) {
    DeclareType9 declareType9 = TempCacheLocator.getTLSTempCache()
                                                .getDeclareType9();
    declareType9.set(this, bSigned, nNbDigitInteger, nNbDigitDecimal);
    // DeclareType9 varLevel9 = new DeclareType9(this, bSigned, nNbDigitInteger,
    // nNbDigitDecimal);
    return declareType9;
  }
  ...
  // csFormat = csFormat.substring(0, n) + csFormat.substring(n+1, nLg-1); //
  // Remove the char
  // return csFormat;
  // }

  public DeclareTypeNumEdited pic9(String csFormat) {
    DeclareTypeNumEdited declareTypeNumEdited = TempCacheLocator.getTLSTempCache()
                                                                .getDeclareTypeNumEdited();
  ...
  public MapRedefine redefinesMap(Form formRedefineOrigin) {
    DeclareTypeMapRedefine declareTypeMapRedefine = TempCacheLocator.getTLSTempCache()
                                                                    .getDeclareTypeMapRedefine();
  ...
  public Edit editOccurs(int nNbOccurs, String csName) {
    ...
    if (pm.isFirstInstance()) {
      this.getProgramManager()
          ...
          .setVarFullName(varEdit.getVarDef()
                                 .getId(),
              csName);
