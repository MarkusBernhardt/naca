...
import com.github.markusbernhardt.jlib.classLoader.JarEntries;
import com.github.markusbernhardt.jlib.classLoader.JarItemEntry;
...
public class OnlineResourceBeanManager extends BaseCloseMBean {
  ...
  void LoadResourceCache(boolean bCacheResourceFiles) {
    ...
    Log.logNormal(
        "LoadResourceCache Unique XML files loaded=" + nNbFiles + "; XML from jar resource=" + nXMLResource + "; Total load Time (ms)=" + sw.getElapsedTime());
