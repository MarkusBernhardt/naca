...
import com.github.markusbernhardt.naca.rt.CESM.CESMLink;
import com.github.markusbernhardt.naca.rt.CESM.CESMQueueManager;
import com.github.markusbernhardt.naca.rt.CESM.CESMReadQueue;
import com.github.markusbernhardt.naca.rt.CESM.CESMReturnCode;
import com.github.markusbernhardt.naca.rt.CESM.CESMStart;
import com.github.markusbernhardt.naca.rt.CESM.CESMWriteQueue;
import com.github.markusbernhardt.naca.rt.CESM.CESMXctl;
...
import com.github.markusbernhardt.naca.rt.misc.CCESMFakeMethodContainer;
...
public class BaseCESMManager extends CJMapObject {
  ...
  public String getLastCommandReturnCode() {
    return m_CESMEnv.getLastCommandReturnCode()
                    .getCode();
  }

  public int getConditionOccured() {
    int n = m_CESMEnv.getLastCommandReturnCode()
                     .getCondition();
    if (isLogCESM)
  ...
  public String getSQLEnvironment() {
    ...
    return m_CESMEnv.getSQLConnection()
  ...
  public boolean hasCredentials() {
    return !m_CESMEnv.getApplicationCredentials()
                     .equals("");
  }

  public String getDeclaredUserId() {
    if (m_CESMEnv.getApplicationCredentials()
                 .length() > 7) {
      return m_CESMEnv.getApplicationCredentials()
                      .substring(5, 8);
    } else {
  ...
  public CESMLink link(Var varProgram) {
    return link(varProgram.getString()
                          .trim());
  }
