 ...
 * 
 */
package com.github.markusbernhardt.naca.rt.base;
...
import com.github.markusbernhardt.naca.rt.basePrgEnv.TransThreadManager;
...
public class JmxGeneralStat extends BaseJmxGeneralStat {
  ...
  protected void buildDynamicMBeanInfo() {
    ...
    // addAttribute("NbSQLObjectsReuse", getClass(), "B_NbSQLObjectsReuse",
    // int.class);
    ...
    // addAttribute("InternalCharBufferSize", getClass(),
    // "G_InternalCharBufferSize", int.class);
    ...
    // addAttribute("I_NbSession_NonFinalized", getClass(),
    // "I_NbSession_NonFinalized", int.class);
    ...
    // addAttribute("NbCurrentOnlineSession", getClass(),
    // "M0_NbCurrentOnlineSession", int.class);
    // addAttribute("NbCurrentAsyncStartSession", getClass(),
    // "M1_NbCurrentAsyncStartSession", int.class);
    // addAttribute("TimeMaxDbIO_ms", getClass(), "NDB0_TimeMaxDbIO_ms",
    // long.class);
    // addAttribute("TimeMoyDbIO_ms", getClass(), "NDB1_TimeMoyDbIO_ms",
    // long.class);
    // addAttribute("TimeSumDbIO_ms", getClass(), "NDB2_TimeSumDbIO_ms",
    // long.class);
    // addAttribute("NbTotalDbIO", getClass(), "NDB3_NbTotalDbIO", int.class);

    // addAttribute("TimeMaxTransaction_ms", getClass(),
    // "NTR0_TimeMaxTransaction_ms", long.class);
    // addAttribute("TimeMoyTransaction_ms", getClass(),
    // "NTR1_TimeMoyTransaction_ms", long.class);
    // addAttribute("TimeSumTransaction_ms", getClass(),
    // "NTR2_TimeSumTransaction_ms", long.class);
    // addAttribute("NbTotalTransaction", getClass(), "NTR3_NbTotalTransaction",
    // int.class);
    // addAttribute("NbCurrentRunningTrans", getClass(),
    // "NTR4_NbCurrentRunningTrans", int.class);

    // addAttribute("TimeMoyTransExceptDbIO_ms", getClass(),
    // "O_TimeMoyTransExceptDbIO_ms", long.class);

    // addAttribute("PermanentDataHep_TenuredGen", getClass(),
    // "P_PermanentDataHep_TenuredGen_Mb", String.class);
