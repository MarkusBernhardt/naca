...
public class RWNumIntComp0 {
  ...
  // static void internalWriteAbsoluteIntComp0(VarBufferPos buffer, int nValue,
  // int nPosition, int nTotalSize)
  // {
  // if(nValue < 0)
  // nValue = -nValue;
  // String csValue = String.valueOf(nValue);
  // return internalWriteAbsoluteIntComp0AsString(buffer, csValue, nPosition,
  // nTotalSize);
  //
  // }
  ...
  // static int internalWriteAbsoluteIntComp0AsString(VarBufferPos buffer, int
  // nOffset, CStr csValue, int nPosition, int nTotalSize)
  // {
  // int nStringLength = csValue.length();
  // if(nTotalSize < nStringLength) // Keeping only rightmostchar form source
  // string
  // {
  // String csSourceString = csValue.substring(nStringLength - nTotalSize);
  // nPosition = buffer.setStringAt(nPosition+nOffset, csSourceString,
  // nTotalSize); // Writing the string
  // }
  // else if(nStringLength < nTotalSize) // Padding with '0' on the left
  // {
  // int nNbZeroToPrefix = nTotalSize - nStringLength;
  // nPosition = buffer.writeRepeatingCharAt(nPosition+nOffset, '0',
  // nNbZeroToPrefix);
  // nPosition = buffer.setStringAt(nPosition, csValue, nStringLength); // Writing
  // the string
  // }
  // else // Same size
  // {
  // nPosition = buffer.setStringAt(nPosition+nOffset, csValue, nStringLength); //
  // Writing the string
  // }
  // return nPosition;
  // }
  ...
  // }
  //
  // static String getAsAbsoluteIntComp0StringAsLong(long lValue, int
  // nNbDigitInteger)
  // {
  // if(lValue < 0)
  // lValue = -lValue;
  ...
  // }
  //
  // static String getAsAbsoluteIntComp0StringAsString(String csValue, int
  // nNbDigitInteger)
  // {
  // String csOutString;
  // int nValueLength = csValue.length();
  // if(nNbDigitInteger < nValueLength) // Keeping only rightmostchar form source
  // string
  // {
  ...
  // public static void fillBlankAsZero(VarBufferPos buffer, int nOffset, int
  // nTotalSize)
  // {
