...
public class Form extends Var {
  public Form(DeclareTypeForm declareTypeForm, String csDeclaredFormName) {
    ...
    SharedProgramInstanceData sharedProgramInstanceData = declareTypeForm.getProgramManager()
  ...
  //
  /*
   * // public Edit GetFieldAt(int nField) // { // assertIfFalse(nField <
   * m_arrFields.size()) ; // return (Edit) m_arrFields.get(nField) ; // }
   */
  ...
  // TempCacheLocator.getTLSTempCache().getInitializeManagerLowValue();
