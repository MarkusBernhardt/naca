 ...
 * 
 */
package com.github.markusbernhardt.naca.rt.appOpening;

import com.github.markusbernhardt.jlib.misc.SortableItem;
...
public class CalendarInstant extends SortableItem {
  ...
  public int compare(SortableItem item) {
    ...
    if (m_nHour == i.m_nHour && m_nMinute == i.m_nMinute && m_nSecond == i.m_nSecond)
      return 0;
    else if (m_nHour < i.m_nHour || (m_nHour == i.m_nHour && m_nMinute < i.m_nMinute)
        || (m_nHour == i.m_nHour && m_nMinute == i.m_nMinute && m_nSecond == i.m_nSecond))
      return -1;
    return 1;
  }
}
