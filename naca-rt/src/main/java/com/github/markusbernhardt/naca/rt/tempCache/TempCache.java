 ...
 * 
 */
package com.github.markusbernhardt.naca.rt.tempCache;
...
import com.github.markusbernhardt.naca.rt.bdb.BtreeKeyDescription;
...
import com.github.markusbernhardt.naca.rt.varEx.CoupleVar;
import com.github.markusbernhardt.naca.rt.varEx.DeclareType9;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeCond;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeEditInMap;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeEditInMapRedefine;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeEditInMapRedefineNum;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeEditInMapRedefineNumEdited;
...
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeForm;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeG;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeMapRedefine;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeNumEdited;
import com.github.markusbernhardt.naca.rt.varEx.DeclareTypeX;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerDouble;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerDoubleEdited;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerInt;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerIntEdited;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerLowValue;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerNone;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerString;
import com.github.markusbernhardt.naca.rt.varEx.InitializeManagerStringEdited;
...
public class TempCache {
  ...
  public BaseProgram popCurrentProgram() {
    ...
    if (!m_stackPrograms.empty()) {
      ...
      if (!m_stackPrograms.empty()) {
        m_CurrentBaseProgramManager = m_stackPrograms.peek()
                                                     .getProgramManager();
        if (m_CurrentBaseProgramManager != null)
  ...
  // public void setCurrentBaseProgramManagerForPreloadOnly(BaseProgramManager
  // baseProgramManager)
  // {
