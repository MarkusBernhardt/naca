...
import com.github.markusbernhardt.jlib.classLoader.CoupleCodeLoader;
...
public class CustomClassDynLoader extends ClassDynLoader {
  ...
  // private synchronized Class loadClassInternal(String name) throws
  ...
  public Class loadClass(String csClassName) {
    ...
    if (bCallOrStdClass) // If we want to share a copy among all programs, do a if(bCall ||
                         // bCopyOrStdClass)
    {
