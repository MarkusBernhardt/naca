...
import com.github.markusbernhardt.naca.rt.varEx.VarDefEncodingConvertibleManagerContainer;

/**
 *
 * @author Pierre-Jean Ditscheid, Consultas SA
 * @version $Id: FileEncodingConverterWithClass.java,v 1.10 2007/06/09 12:04:22
 *          u930bm Exp $
 */
public class FileEncodingConverterWithClass extends FileEncodingConverter {
  ...
  private boolean convert(String csCopyClass) {
    ...
    VarBase varRoot = converterProgram.getProgramManager()
                                      .getRoot();
