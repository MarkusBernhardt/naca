...
public class SQLConnection extends DbConnectionBase {
   ...
   * 
   * @see
   * jlib.sql.DbConnectionBase#createAndPrepareWithException(java.lang.String,
   * boolean)
   */
  @Override
  public DbPreparedStatement createAndPrepareWithException(String csQuery, boolean bHoldability) throws TechnicalException {
