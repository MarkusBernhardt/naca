...
public class VarDefNumDecSignComp0 extends VarDefNum {
  ...
  // private Dec readSignedDecComp0(VarBufferPos buffer, int nNbDigitInteger, int
  // nNbDigitDecimal)
  // {
  // if(nNbDigitDecimal == 0)
  // {
  // long lInt = internalReadSignedIntComp0AsLong(buffer,
  // buffer.m_nAbsolutePosition, nNbDigitInteger);
  // Dec dec = new Dec(lInt, "");
  // return dec;
  // }
  // else
  // {
  // long lInt = RWNumIntComp0.internalReadIntComp0AsLong(buffer,
  // buffer.m_nAbsolutePosition, nNbDigitInteger);
  // String csDec = internalReadSignedIntComp0AsString(buffer,
  // buffer.m_nAbsolutePosition+nNbDigitInteger, nNbDigitDecimal);
  // if(csDec.length() >= 1 && csDec.charAt(0) == '-')
  // {
  // lInt = -lInt;
  // csDec = csDec.substring(1);
  // }
  //
  //// int nDec = internalReadSignedIntComp0(buffer,
  // m_nAbsolutePosition+nNbDigitInteger, nNbDigitDecimal);
  //// if(nDec < 0)
  //// {
  //// nInt = -nInt;
  //// nDec = -nDec;
