 ...
 */
package com.github.markusbernhardt.naca.rt.programPool;
...
import com.github.markusbernhardt.jlib.misc.VectorDyn;
...
import com.github.markusbernhardt.naca.rt.varEx.InternalCharBufferCompressedBackup;
import com.github.markusbernhardt.naca.rt.varEx.VarDefBase;
import com.github.markusbernhardt.naca.rt.varEx.VarDefBuffer;
import com.github.markusbernhardt.naca.rt.varEx.VarDefForm;
...
public class SharedProgramInstanceData extends CJMapObject {
  ...
  synchronized public void prepareAutoRemoval() {
    // Do not manager m_bCanWrite, as we are in unloading phase, and we don't care
    // about catalog at this stage
    if (m_arrVarDef != null) {
  ...
  // synchronized public void saveStat(PooledProgramInstanceStat
  // pooledProgramInstanceStat)
  // {
  ...
  // if(m_arrVarDef != null)
  // pooledProgramInstanceStat.m_nBufferSize =
  // m_internalCharBufferOriginal.getBufferSize();
  // }
  // }
  ...
  // public void serialize(String csVarDefCatalogueSerilizationPath, String
  // csFileName)
  // {
  ...
  // {
  // Hashtable<VarDefBase, Integer> hashVarDefById = new Hashtable<VarDefBase,
  // Integer>();
  // out.writeInt(1);
  // if(m_arrVarDef != null)
  ...
  // out.writeInt(0);
  //
  // // Serialized object themselves; used for correct creation at deserialization
  // time
  ...
  // }
  //
  // public boolean deserialize(String csVarDefCatalogueSerilizationPath, String
  // csFileName)
  // {
  // String csFullFileName = csVarDefCatalogueSerilizationPath + csFileName;
  // try
  ...
  public String getFormName(int n) {
    ...
    if (varDef != null) {
      String csName = varDef.getFullName(this)
                            .toUpperCase();
  ...
  public String dumpAll() {
    ...
    if (m_arrInitialValue != null) {
      for (int n = 0; n < m_arrInitialValue.size(); n++) {
        ...
        if (m_arrInitialValue.get(n) != null)
          sb.append(m_arrInitialValue.get(n)
                                     .toString()
              + "\r\n");
      }
    }
    ...
    if (m_arrVarDefForm != null) {
      for (int n = 0; n < m_arrVarDefForm.size(); n++) {
        sb.append(m_arrVarDefForm.get(n)
                                 .toString()
            + "\r\n");
      }
    }
