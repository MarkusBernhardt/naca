...
public class VarBuffer extends InternalCharBuffer {
  ...
  // {
  // String csName =
  // varDef.getFullName(getProgramManager().getSharedProgramInstanceData());
  ...
  // public void addMapAssociatedSemanticContext(Edit edit, String
  // csSemanticContext)
  // {
  // if(m_arrMapAssociatedSemanticContext == null)
  // m_arrMapAssociatedSemanticContext = new ArrayList();
  // CEditSemanticContextMapAssoc EditSemanticContextMapAssoc = new
  // CEditSemanticContextMapAssoc(edit, csSemanticContext);
  ...
  // public int writeCopy(int nPositionDest, int nPositionSource, int
  // nNbCharsToCopy)
  // {
  ...
  // public void copyInternalData(int nPositionDest, VarBufferPos Source, int
  // nNbCharsToCopy)
  // {
  ...
  // public void setWithNoConvertEbcdicToUnicodeAtOffsetDest(byte tBytesSource[],
  // int nOffsetDest, int nLength)
  // {
  // for(int n=0; n<nLength; n++)
  // {
  // int nByte = tBytesSource[n];
