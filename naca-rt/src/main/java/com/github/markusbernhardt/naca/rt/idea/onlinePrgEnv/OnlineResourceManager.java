...
import com.github.markusbernhardt.jlib.display.ResourceManager;
import com.github.markusbernhardt.jlib.log.Log;
import com.github.markusbernhardt.jlib.misc.FileSystem;
import com.github.markusbernhardt.jlib.misc.LdapRequester;
...
import com.github.markusbernhardt.jlib.xml.XMLUtil;
import com.github.markusbernhardt.jlib.xml.XSLTransformer;
import com.github.markusbernhardt.naca.rt.basePrgEnv.BaseResourceManager;
import com.github.markusbernhardt.naca.rt.idea.manager.PreloadProgramSettings;
import com.github.markusbernhardt.naca.rt.idea.manager.ProgramPreloader;
import com.github.markusbernhardt.naca.rt.idea.semanticContext.CMenuDef;
import com.github.markusbernhardt.naca.rt.idea.semanticContext.SemanticManager;
import com.github.markusbernhardt.naca.rt.idea.view.XMLMerger;
import com.github.markusbernhardt.naca.rt.idea.view.XMLMergerManager;
...
public class OnlineResourceManager extends BaseResourceManager {
  ...
  protected boolean m_bKeepPreloadedProgramList = false; // true if you want to register into [m_csPreLoadProgramList] the preloaded
                                                         // program list; usefull to build the list of program from the dir
  protected boolean m_bPreLoadAllProgramFromList = false; // true if load all programs indiciated in [m_csPreLoadProgramList]
  protected String m_csPreLoadProgramList = ""; // Gives the path and name of the file indicating a program list to be loaded in
                                                // mode m_bPreLoadAllProgramFromList; it is updated in mode
                                                // m_bPreLoadAllProgramFromDir
  ...
  private ResourceManager m_StdResourceManager = new ResourceManager();
  ...
  private void doInitialize(String csINIFilePath, boolean bLoadSemanticContextDef) {
    ...
    if (bLoadSemanticContextDef) {
      // Load semantic context data dictionnary: Defines semantic context associtaed
      // to DB columns
  ...
  private void preloadPrograms() {
    ...
    if (programPreloader != null && arrProgramToPreload != null) {
      ...
      if (BaseResourceManager.isAsynchronousPreloadPrograms()) {
        AsynchronousProgramPreloaderThread asynchronousProgramPreloaderThread = new AsynchronousProgramPreloaderThread(this, programPreloader,
            arrProgramToPreload, csProgramListToKeep);
  ...
  public void AsynchronouslyPreloadPrograms(ArrayList<PreloadProgramSettings> arrProgramToPreload, ProgramPreloader programPreloader,
