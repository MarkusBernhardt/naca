 ...
 *
 * Copyright (c) 2005, 2006, 2007, 2008 Publicitas SA. Licensed under LGPL
 * (LGPL-LICENSE.txt) license.
 */
/// *
...
// {
// public ProgramInstance(String csProgramName, BaseProgram program, boolean
/// bNewProgramInstance)//, ClassLoaderUnloaderRef classLoaderUnloaderRef)
// {
...
/// m_program.getProgramManager().getSharedProgramInstanceData();
