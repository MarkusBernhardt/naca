 ...
 * @version $Id: VarDefEncodingConvertibleManagerContainer.java,v 1.8 2007/06/09
 *          12:04:22 u930bm Exp $
 */
public class VarDefEncodingConvertibleManagerContainer {
  ...
  public VarDefEncodingConvertibleManager getEncodingManager(VarBase varDest) {
    ...
    if (encodingManager == null) {
      ...
      varDest.getVarDef()
             .getChildrenEncodingConvertiblePosition(encodingManager);
  ...
  void getConvertedBytesAsciiToEbcdic(VarBase varSource, byte tbyDest[], int nLengthDest) {
    ...
    if (v == null) {
      ...
      varSource.getVarDef()
               .getChildrenEncodingConvertiblePosition(v);
      v.compress();
      m_hash.put(varId, v);
    }
    if (v != null) {
