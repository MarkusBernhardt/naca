...
public abstract class VarDefItemManager {
  ...
  // abstract VarDefBuffer createVarDefItems(ProgramManager programManager,
  // VarDefBase varDefMaster, int x, VarDefBase varDefOccursParent);
  // abstract VarDefBuffer createVarDefItems(ProgramManager programManager,
  // VarDefBase varDefMaster, int y, int x, VarDefBase varDefOccursParent);
  // abstract VarDefBuffer createVarDefItems(ProgramManager programManager,
  // VarDefBase varDefMaster, int z, int y, int x, VarDefBase varDefOccursParent);
