...
import com.github.markusbernhardt.jlib.sql.BaseDbColDefinitionFactory;
import com.github.markusbernhardt.jlib.sql.DbColDefErrorManager;
...
public class SQLLoad extends BaseSQLUtils {
  ...
  SQLLoadStatus executeStatement(IntegerRef rnNbRecord, LoadScriptLineInfo loadInfo) {
    ...
    ArrayList<BaseDbColDefinition> arrDbColDef = dbColDefinitionFactory.makeArrayDbColDefinitions(m_dbConnection, loadInfo.getTablePrefix(),
  ...
  private SQLLoadStatus insertData(IntegerRef rnNbRecordInserted, String csLogicalFileDataIn, String csTableFullName,
      ArrayList<BaseDbColDefinition> arrDbColDef, boolean bLoadReplace) {
