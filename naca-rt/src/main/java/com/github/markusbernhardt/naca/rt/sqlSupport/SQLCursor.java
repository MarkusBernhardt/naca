...
public class SQLCursor extends CJMapObject // extends SQLCursor
{
  ...
  public void setQuery(String csQuery) {
    ...
    // File Line
    // m_SQL = m_programManager.getOrCreateSQLForCursor(csQuery, this);//,
    // csFileLine);
  ...
  // public SQLCursor(ProgramManager programManager, VarBuffer Working,
  // CESMEnvironment env, String csQuery, CSQLStatus sqlstatus)
  // {
  // m_programManager = programManager;
  // m_SQL = new SQL(Working, env, csQuery, true, sqlstatus);
  // m_bOpen = false;
