...
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttrColor;
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttrHighlighting;
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttrIntensity;
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttrModified;
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttrProtection;
import com.github.markusbernhardt.naca.rt.mapSupport.MapFieldAttribute;
...
public class OnlineProgram extends BaseProgram {
  ...
  /**
   * Method: setEnvironment Internal usage only Defined the current exnvironment
   * for GUI apps
   * 
   * @param: IN
   *           CESMManager man: Current GUI manager
   * @param: IN
   *           CESMUSerEnv uenv: Current user envionnement
   */

  protected int getCursorPosition() {
    /*
     * This EIB field contains the cursor address (position) associated with the
     * last terminal control or Basic Mapping Support (BMS) input operation from a
     * display device such as a terminal. For COBOL: PIC S9(4) COMP
     */
  ...
  /**
   * @return String This EIB field contains the time at which the task is started
   *         (this field is updated by the ASKTIME command). The time is in packed
   *         decimal form (0HHMMSS+). For COBOL: PIC S9(7) COMP-3
   */
  ...
  /**
   * @param Edit
   *          e: Edit whose color attribute is to be tested
   * @param MapFieldAttrColor
   *          color: Color attribute definition
   * @return true if the edit e has the color identified in parameter, false
   *         otherwise
   */
  ...
  /**
   * @param MapFieldAttrIntensity
   *          intens: Intensity attribute
   * @param Edit
   *          e: Destination edit Set the edit e intensity attribute's value the
   *          intens's value.
   */
  ...
  /**
   * @param MapFieldAttribute
   *          att: Contains all edit attribute values (
   * @param Edit
   *          e: Destination edit Set the edit e attributes to all values
   *          contained in att
   */
  ...
  /**
   * @param MapFieldAttrProtection
   *          att: Protectection attribute to set to e
   * @param Edit
   *          e: Destination edit Set the edit it's protection attribute value
   */
  ...
  /**
   * @param MapFieldAttrModified
   *          att: Modified attribute to set to e
   * @param Edit
   *          e: Destination edit Set the edit it's modified attribute value
   */
  ...
  /**
   * @param Edit
   *          e Set the cursor on the edit e
   */
  ...
  /**
   * @param MapFieldAttrColor
   *          color: Source color attribute
   * @param Edit
   *          e: Destination edit Set the edit it's color attribute value
   */
  ...
  // {
  // if(isLog.logFineTrace())
  // Log.logFineTrace("moveLength_V_E:" + v.getSTCheckValue() + ":" +
  // e.getSTCheckValue());
  //
  // int n = v.getInt() ;
  // e.setLength(n);
  ...
  // * Set the edit highlight attribute as blink, if var's value is 255 (high
  // value)
  // * * Set the edit highlight attribute as normal, if var's value is not 255
  // (high value)
  // */
  ...
  /**
   * @param MapFieldAttrHighlighting
   *          att: Source highligt attribute
   * @param Edit
   *          e: Destination edit Set the edit it's highlighting attribute's value
   */
  ...
  /**
   * @param Edit
   *          e: Destination edit Set the edit highlight attribute as normal
   */
  ...
  /**
   * @param Edit
   *          e: Destination edit Set the edit highlight attribute as reverse
   */
  ...
  /**
   * @param Edit
   *          e: Destination edit Set the edit highlight attribute as blink
   */
  ...
  /**
   * @param Edit
   *          e: Destination edit Set the edit highlight attribute as underline
   */
  ...
  // Var <-> Key
  /**
   * Method: isDifferent return false if the var's value equals the key value,
   * true otherwise
   * 
   * @param: IN
   *           Var var
  ...
  /**
   * Method: isDifferent return true if the var's value equals the key value
   * 
   * @param: IN
   *           Var var
   * @param: IN
  ...
  /**
   * Method: move move the key's value into a var
   * 
   * @param: IN
   *           KeyPressed k
   * @param: OUT
