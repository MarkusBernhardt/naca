...
import com.github.markusbernhardt.naca.rt.varEx.VarTypeEnum;
...
public class VarFPacRaw extends Var {
  ...
  public void copy(VarFPacRaw varSource) {
    ...
    // m_bufferPos.copyBytes(m_bufferPos.m_nAbsolutePosition, nNbCharToCopy,
    // varSource.getBuffer().m_nAbsolutePosition, varSource.getBuffer());
