...
public class CallParamByCharBuffer extends CCallParam {
  ...
  public void MapOn(Var varLinkageSection) {
    ...
    // TODO Contr�le si contr�le sur longueur du buffer ou longueur de
    // varLinkageSection
    if (nPositionDest + nNbCharsToCopy > nBuffetDestSize) {
      assertIfFalse(false,
          "Assertion: CallParamByCharBuffer.MapOn; Destination Buffer too small; Source length=" + nNbCharsToCopy + " Destination length=" + nBuffetDestSize);
    }
