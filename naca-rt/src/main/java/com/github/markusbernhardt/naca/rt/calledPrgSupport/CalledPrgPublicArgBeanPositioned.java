...
import com.github.markusbernhardt.naca.rt.batchOOApi.FillerReadWriteExt;
import com.github.markusbernhardt.naca.rt.batchOOApi.ModeReadWriteExt;
import com.github.markusbernhardt.naca.rt.varEx.Var;

/**
 *
 * @author Pierre-Jean Ditscheid, Consultas SA
 * @version $Id: CalledPrgPublicArgBeanPositioned.java,v 1.1 2007/09/21 15:11:30
 *          u930bm Exp $
 */
public abstract class CalledPrgPublicArgBeanPositioned extends BaseCalledPrgPublicArgPositioned {
  ...
  public void MapOn(Var varLinkageSection) {
    ...
    fillRW();
    varLinkageSection.set(getFiller().getBuffer()
                                     .getString());
  ...
  public void doFillWithVar(Var varSource) {
    ...
    getFiller().allocOrResetBufferExt();
    getFiller().getBuffer()
               .setStringAt(0, m_csValue, m_csValue.length());
    fillRW();
    getFiller().setMode(ModeReadWriteExt.Unknown);
  }
