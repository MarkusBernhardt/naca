...
public abstract class Var extends VarAndEdit {
  ...
  public void adjust(VarDefBuffer varDefGetAt, Var varGetAt) {
    ...
    // int nOffset = m_bufferPos.m_nAbsolutePosition -
    // m_varDef.m_nDefaultAbsolutePosition;
    // varGetAt.m_bufferPos.shareDataBufferFrom(m_bufferPos);
    // varGetAt.m_bufferPos.m_nAbsolutePosition =
    // varDefGetAt.m_nDefaultAbsolutePosition + nOffset;
  }
  ...
  public Var allocCopy(VarDefBuffer varDefItem) {
    ...
    // assertIfFalse(varItem.m_bufferPos.getProgramManager() ==
    // m_bufferPos.getProgramManager());
  ...
  public void set(EditInMapRedefine varSource) {
    // varSource.m_Var2EditInMap.m_varDef.transfer(varSource.m_Var2EditInMap.m_buffer,
    // this);
    int n = 0;
    assertIfFalse(false);
  }
  ...
  public String getAsAlphaNumString() {
    String cs = m_varDef.getAsAlphaNumString(m_bufferPos)
                        .getAsString();
    return cs;
  }
