...
import com.github.markusbernhardt.naca.rt.bdb.BTreeCommandSort;
import com.github.markusbernhardt.naca.rt.bdb.FileKeyExporter;
import com.github.markusbernhardt.naca.rt.dbUtils.DbTransfer;
import com.github.markusbernhardt.naca.rt.dbUtils.FileExporter;
import com.github.markusbernhardt.naca.rt.dbUtils.SQLFileExecutor;
import com.github.markusbernhardt.naca.rt.dbUtils.SQLLoad;
import com.github.markusbernhardt.naca.rt.dbUtils.SQLUnload;
import com.github.markusbernhardt.naca.rt.exceptions.AbortSessionException;
import com.github.markusbernhardt.naca.rt.fileConverter.FileConverter;
import com.github.markusbernhardt.naca.rt.fileConverter.FileEncodingConverterWithClass;
import com.github.markusbernhardt.naca.rt.fileConverter.FileEncodingConverterWithDesc;
import com.github.markusbernhardt.naca.rt.fileConverter.FileSearchGeneration;
import com.github.markusbernhardt.naca.rt.fileConverter.FileUtil;
import com.github.markusbernhardt.naca.rt.misc.CCommarea;
import com.github.markusbernhardt.naca.rt.misc.MailUtil;
...
public class BatchMain {
  ...
  public static int executeTranscodedProgram(String csConfigFile, DbConnectionBase dbConnection, String csPrgClassName) {
    ...
    try {
      ...
      // if (csParameter != null)
      // {
      // InternalCharBuffer charBuffer = new InternalCharBuffer(2 +
      // csParameter.length());
      // int nPos = 0;
      // nPos = charBuffer.writeShort(new Integer(csParameter.length()).shortValue(),
      // nPos);
  ...
  static void displayHelp() {
    ...
    System.out.println(
        "	Last argument must be \"SORT FIELDS=(1 Based position,Length,CH|PD|BI|FI,A|D)+\"	// Describe the sort key e.g. : \"SORT FIELDS=(1,8,CH,A,9,4,PD,A,13,2,CH,A)\"");
  }
}