...
public class CCESMFakeMethodContainer {
  ...
  /*
   * public CCESMFakeMethodContainer allLowValues() { return this ; } public
   * CCESMFakeMethodContainer bySpaces() { return this ; } public
   * CCESMFakeMethodContainer leadingSpaces() { return this ; } public
   * CCESMFakeMethodContainer by(int n) { return this ; } public
   * CCESMFakeMethodContainer by(String n) { return this ; } public
   * CCESMFakeMethodContainer by(Var n) { return this ; }
   */
  ...
  /*
   * public CCESMFakeMethodContainer concat(Var var) { return this ; } public
   * CCESMFakeMethodContainer concat(String s) { return this ; }
   */
  ...
  /*
   * public CCESMFakeMethodContainer first(String string) { return this ; }
   */
  /*
   * public CCESMFakeMethodContainer concatDelimitedBy(Var w_Travail, String
   * string) { return this ; } public CCESMFakeMethodContainer delimitedBy(String
   * string) { return this ; } public CCESMFakeMethodContainer
   * delimitedByAll(String string) { return this ; }
   */
