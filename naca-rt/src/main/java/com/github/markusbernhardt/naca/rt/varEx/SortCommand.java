...
import com.github.markusbernhardt.naca.rt.bdb.BtreeFile;
...
public class SortCommand {
  ...
  protected void release(Var varRecord) // A record is given by a paragraph for btrieve importation
  {
    ...
    if (m_sortDescriptorDeclared != null) {
      bVariableLength = m_sortDescriptorDeclared.hasVarVariableLengthMarker(); // The sort descriptor has a variable length marker: The data is of variable
                                                                               // length
  ...
  // {
  // if(tSource[n] == 0x10 && tSource[n+1] == 0x2d && tSource[n+2] == 0x26 &&
  // tSource[n+3] == 0x0c)
  // {
  // return true;
  // }
