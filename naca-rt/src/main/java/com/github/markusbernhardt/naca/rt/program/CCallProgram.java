 ...
 */
package com.github.markusbernhardt.naca.rt.program;
...
import com.github.markusbernhardt.naca.rt.varEx.CallParamByLength;
import com.github.markusbernhardt.naca.rt.varEx.CallParamByRef;
import com.github.markusbernhardt.naca.rt.varEx.CallParamByStringValue;
import com.github.markusbernhardt.naca.rt.varEx.CallParamByValue;
...
public class CCallProgram extends CJMapObject {
   ...
   * @param Class
   *          classPrgToCall: class to load dynamically and call Internal usage
   *          only
   */
   ...
   *          Runtime environnement
   * @param String
   *          csPrgClassName: class name to load dynamically and call Internal
   *          usage only
   */
  ...
  /**
   * Must be called explicitly to terminate all arguments passing to a called
   * program
   */
  ...
  /**
   * @param Var
   *          var: Variable to pass by value to the called program
   * @return this The variable var will be passed by value, so even if modified in
   *         called prog., it's value will stay unmodified in caller prog. They do
   *         not share the same variable.
   */
  ...
  /**
   * @param Var
   *          var: Variable to pass by reference to the called program
   * @return this The variable var will be passed by reference, so if it is
   *         modified in called prog., it's value will also be modified in caller
   *         prog. They both share the same variable.
   */
  ...
  /**
   * @param Var
   *          var: Variable to pass whose length if passed by value to the called
   *          program
   * @return this The variable's lengthvar will be passed by value to the called
   *         program
   */
