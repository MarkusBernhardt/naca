 ...
 * @version $Id: BtreeKeySegmentBinary.java,v 1.11 2007/01/09 14:41:39 u930di
 *          Exp $
 */
public class BtreeKeySegmentBinary extends BtreeKeySegment {
  ...
  int compare(byte tby1[], byte tby2[]) {
    ...
    // else // m_nKeyLength == 2
    // {
    // int s1 = LittleEndingUnsignBinaryBufferStorage.readShort(tby1,
    // m_nKeyPosition);
    // int s2 = LittleEndingUnsignBinaryBufferStorage.readShort(tby2,
    // m_nKeyPosition);
    // if(s1 == s2)
    // return 0;
    // if(s1 < s2)
