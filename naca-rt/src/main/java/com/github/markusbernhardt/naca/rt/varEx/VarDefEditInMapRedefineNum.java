...
import com.github.markusbernhardt.naca.rt.misc.NumberParserDec;
...
public class VarDefEditInMapRedefineNum extends VarDefEditInMapRedefineBase {
  ...
  // private void internalEditPhysicalWrite(VarBufferPos bufferDest, VarDefBuffer
  // varSource, VarBufferPos bufferSource)
  // {
  ...
  // bufferDest.copyBytesFromSource(getBodyAbsolutePosition(bufferDest),
  // bufferSource, varSource.getBodyAbsolutePosition(bufferSource),
  // nNbCharToCopy);
  // }
  ...
  private void writeEditLeftPadding(VarBufferPos buffer, int nValue) {
    ...
    // RWNumIntComp0.internalWriteAbsoluteIntComp0(buffer, nValue, nBodyPosStart,
    // nBodyLength);
