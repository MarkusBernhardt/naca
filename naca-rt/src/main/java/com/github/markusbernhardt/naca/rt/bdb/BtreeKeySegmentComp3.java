...
public class BtreeKeySegmentComp3 extends BtreeKeySegment {
  ...
  int compare(byte tby1[], byte tby2[]) {
    ...
    // int n = 0;
    // long l1 = Pic9Comp3BufferSupport.getAsLong(tby1, m_nKeyPosition,
    // m_nNbDigitInteger, m_nKeyLength);
    // long l2 = Pic9Comp3BufferSupport.getAsLong(tby2, m_nKeyPosition,
    // m_nNbDigitInteger, m_nKeyLength);
    //
    // if(l1 == l2)
    // n = 0;
