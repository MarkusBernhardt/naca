...
import com.github.markusbernhardt.naca.rt.accounting.AccountingRecordProgram;
...
import com.github.markusbernhardt.naca.rt.sqlSupport.SQLConnection;
...
public abstract class BaseEnvironment extends CJMapObject implements SessionEnvironmentRequester {
  ...
  public DbConnectionBase getSQLConnection() {
    if (m_SQLConnection == null && m_connectionManager != null) {
      try {
        ...
        // JVMReturnCodeManager.exitJVM(8); // No connection provided: Do not exit as it
        // kills tomcat !
      }
    }
  ...
  public void setExternalDbConnection(DbConnectionBase dbConnection) {
    ...
    } else // No db connection provided: It means that nacaRT must estblish itslef the
           // connection
    {
