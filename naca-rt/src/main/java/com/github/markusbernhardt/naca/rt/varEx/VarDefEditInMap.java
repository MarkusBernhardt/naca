...
public class VarDefEditInMap extends VarDefEdit {
  ...
  // private int writeEditRightPadding(VarBufferPos buffer, int nOffset, String
  // cs, char cPad, InitializeCache initializeCache)
  // {
  // int nBodyPosStart = getBodyAbsolutePosition(buffer);
  // int nBodyLength = getBodyLength();
  // return internalWriteRightPadding(buffer, nBodyPosStart+nOffset, nBodyLength,
  // cs, cPad);
  // }
  // ///////////
  // protected int internalWriteRightPadding(VarBufferPos buffer, int nPosition,
  // int nTotalSize, String cs, char cPad)
  // {
  // int nLength = 0;
  // if(cs != null)
  // {
  ...
  //
  // private int writeEditRightPadding(VarBuffer buffer, String cs, char cPad, int
  // nAbsolutePosition, int nTotalSize)
  // {
  // return internalWriteRightPadding(buffer, nAbsolutePosition, nTotalSize, cs,
  // cPad);
  // }
