...
/**
 * Declares and registers the <i>System</i> flow. Events reporting exceptions,
 * wrong data, or anomalous circumstances should belong to the <i>System</i>
 * flow.
 * <p/>
 * {@link LogCenter}s assigned to the <i>System</i> flow only accept
 * <i>System</i> events.
 * 
 * @author PJD
 */
