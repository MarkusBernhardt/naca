...
import com.github.markusbernhardt.jlib.log.Asserter;
import com.github.markusbernhardt.jlib.misc.AsciiEbcdicConverter;
import com.github.markusbernhardt.jlib.misc.BasePic9Comp3BufferSupport;
import com.github.markusbernhardt.jlib.misc.Comp3Support;
import com.github.markusbernhardt.jlib.misc.DecBase;
import com.github.markusbernhardt.jlib.misc.NumberParser;

/**
 *
 * @author Pierre-Jean Ditscheid, Consultas SA
 * @version $Id: DbColDefinitionDecimal.java,v 1.7 2007/05/08 16:53:12 u930di
 *          Exp $
 */
public class DbColDefinitionDecimal extends BaseDbColDefinition {
  ...
  // public int setByteValue(byte arrByteValue[], int nSourceOffset, boolean
  // bEbcdicInput, ColValueGeneric colValueGenericDest)
  // {
  // int nSize = 1+(m_nNbDigits / 2);
  // String cs = getAsString(arrByteValue, nSourceOffset, m_nNbDigits,
  // m_nNbDecimals, nSize);
  ...
  public int setByteValueInStmtCol(DbColDefErrorManager dbColDefErrorManager, DbPreparedStatement stmt, int nCol, byte arrByteValue[], int nSourceOffset,
  ...
  // private String getAsString(byte acBuffer[], int nAbsolutePosition, int
  // nNbDigits, int nNbDecimals, int nTotalSize)
  // {
  // StringBuilder cs = null;
  // int nPosDecimalDot = -1;
  // boolean bAddLeadingDigit = true;
  ...
  // {
  // nPosDecimalDot = nNbDigitsInteger;
  // if((nNbDigits % 2) == 0) // Even number of digits: A leading nibble has been
  // added
  // bAddLeadingDigit = false;
  // cs = new StringBuilder(2+nNbDigits);
  // }
  ...
  // {
  // if(nPosDecimalDot != -1)
  // nPosDecimalDot++; // Right shift decimal dot (if one has been set) as we have
  // added a leading '-'
  // cs.insert(0, '-');
  // }
  // }
