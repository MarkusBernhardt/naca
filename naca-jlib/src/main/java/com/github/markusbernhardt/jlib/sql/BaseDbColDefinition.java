...
public abstract class BaseDbColDefinition {
  ...
  public abstract boolean fillCallableStatementParam(int nParamId, StoredProcParamDescBase storedProcParamDescBase,
  ...
  // public abstract int setByteValue(byte arrByteValue[], int nSourceOffset,
  // boolean bEbcdicInput, ColValueGeneric colValueGenericDest);
  public abstract int setByteValueInStmtCol(DbColDefErrorManager dbColDefErrorManager, DbPreparedStatement stmt, int nCol, byte arrByteValue[],
      int nSourceOffset, boolean bEbcdicInput);
