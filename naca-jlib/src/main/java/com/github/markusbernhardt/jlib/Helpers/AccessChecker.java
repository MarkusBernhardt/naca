 ...
 */
package com.github.markusbernhardt.jlib.Helpers;
 ...
 * <p>
 * (Examples are given in Xml, even if the implementation is not necessarily
 * Xml).
 * </p>
 * There are three different structures:
 * <ul>
 * <li>A list of users. Each users can belong to none, one or several
 * groups.</li>
 * <li>A list of groups. As the users, groups can belong to none, one or several
 * groups.</li>
 * <li>A function tree. Each function has two access list: one for reading, one
 * for writing. Access lists consist in list of users and groups.</li>
 * </ul>
 ...
 * <ul>
 * <li>A function path:
 * <code>administration / customers / changePassword</code>.</li>
 ...
 * <ul>
 * <li>Initially, the user hasn't access to the requested function. A
 * <code>hasAccess</code> flag is initialized to <code>false</code>.</li>
 * <li>The function tree is parsed from the top, following the function
 * path.</li>
 * <li>If the <code>hasAccess</code> is <code>false</code> then only the
 * <code>grant</code> list is checked.</li>
 * <li>If the <code>hasAccess</code> is <code>true</code> then only the
 * <code>deny</code> list is checked.</li>
 * <li>If the user name, or the name of any group he belongs to, is present in
 * the checked <code>grant</code> or <code>deny</code> list, then the
 * <code>hasAccess</code> flag is switched to the correspondent value.</li>
 * <li>When the function tree exploration is finished, the current value of
 * <code>hasAccess</code> determines whether or not the user has access.</li>
 * </ul>
 * </p>
 * <p>
 * This base class has no serialization / deserialization functionalities. It
 * can be extended to implement these tasks in the most suitable way.
 * </p>
 * 
 * @author U930GN
 */
public class AccessChecker {
  ...
  public String toString() {
    ...
    // ............................................
    s.append("	<users>\r\n");
    Iterator<Map.Entry<String, List<String>>> usersIterator = _users.entrySet()
                                                                    .iterator();
    ...
    // ...........................................
    s.append("	<groups>\r\n");
    Iterator<Map.Entry<String, List<String>>> groupsIterator = _groups.entrySet()
                                                                      .iterator();
  ...
  // **********************************
  /**
   * Default class construcutor. The access structure is initialized as empty. It
   * has to be populated by calling other methods in the class:
   * <ul>
   * <li>Declaring users and groups of users with {@link #declareUser},
   * {@link #declareGroup}.</li>
   * <li>Grant access to functions with {@link #grantWriteAccessToUsersOrGroups
   * and {@link #grantReadAccessToUsersOrGroups}.</li>
   * <li>Deny access to functions with {@link #denyWriteAccessToUsersOrGroups and
   * {@link #denyReadAccessToUsersOrGroups}.</li>
   * </ul>
   * Class can be extended to implement automatic population from external data,
   * like a database, a file, a stream...
   */
   ...
   *          The user name.
   * @param groupsList
   *          The list of groups where the user has to be included. If
   *          <code>null</code> or empty, the user is not included in any group.
   *          All specified groups have to be previously declared in the
   *          <code>groups</code> section ({@link #declareGroup}, or loaded with
   *          {@link #load} or {@link #AccessChecker(InputStream)}). The
   *          <code>groupsList</code> parameter can be a comma-separated list of
   *          group names as:
   * 
   *          <pre>
   *          "users,administrators,backup"
   *          </pre>
   * 
   * @exception Exception
   *              if the specified <code>userName</code> already exists.
   * @exception Exception
   *              if any of the specified groups in the <code>groupsList</code>
   *              parameter isn't declared.
   */
  public void declareUser(String userName, String groupsList) throws Exception {
    try {
      ...
      // ******************************** Adds the user to the specified list of
      // groups ******************
   ...
   *          All specified groups have to be previously declared in the
   *          <code>groups</code> section ({@link #declareGroup}, or loaded with
   *          {@link #load} or {@link #AccessChecker(InputStream)}). The parameter
   *          can be a comma-separated list of group names as:
   * 
   *          <pre>
   *          "users,administrators,backup"
   *          </pre>
   * 
   * @exception Exception
   *              if the specified <code>userName</code> isn't declared.
   * @exception Exception
   *              if any of the specified groups in the <code>groups</code>
   *              parameter isn't declared.
   */
  public void includeUserInGroups(String userName, String groups) throws Exception {
    try {
      ...
      // ........................... Retrieves the list of groups the user is already
      // in .................
   ...
   * @exception Exception
   *              If specified name is null or empty.
   * @exception Exception
  ...
  /**
   * Declares a new group in the 'groups' section, as a child of the specified
   * parent group. If the specified group already exists, then the method only
   * adds the group in the specified parent group.
   * 
   * @param groupName
   *          The new group's name.
   * @param parentGroup
  ...
  public void includeGroupInGroups(String groupName, String parentGroups) throws Exception {
    try {
      ...
      // ........................... Retrieves the list of groups the group is already
      // in ................
      ...
      for (int n = 0; n < nn; n++) {
        ...
        // ................................ Adds the group in the groups's list of
        // groups ..................
        groupsList.add(group[n]);
      }
    }
   ...
   * 
   * @param functionPath
   *          The path to the function the access is granted. Can be on the form
   *          of:
   * 
   *          <pre>
   *          "userManager/userProfile/userChangePassword"
   *          </pre>
   * 
   *          . If function path doesn't exist yet, it is created by this call.
   * @param usersOrGroups
   *          The list of users and/or groups to set the access. Is a comma
   *          separated list.
   * @exception Exception
   *              if no user has been yet declared.
   * @exception Exception
   *              if <code>parameterName</code> is not null, and
   *              <code>parameterValue</code> is.
   * @exception Exception
   *              if <code>functionPath</code> is empty or null.
   * @exception Exception
   *              if <code>usersOrGroups</code> is empty or null.
   * @exception Exception
   *              if <code>usersOrGroups</code> contains undeclared users or
   *              groups.
   */
   ...
   *          separated list.
   * @param parameterName
   *          If not <code>null</code>, sets the access to a particular parameter
   *          and value.
   * @param parameterValue
   *          Cannot be <code>null</code> if <code>parameterName</code> isn't.
   *          Sets the access to a particular parameter and value.
   * @exception Exception
   *              if no user has been yet declared.
   * @exception Exception
   *              if <code>parameterName</code> is not null, and
  ...
  public void grantWriteAccessToUsersOrGroups(String functionPath, String usersOrGroups, String parameterName, String parameterValue) throws Exception {
    try {
      ...
      throw new Exception(ParseError.parseError(
          "AccessChecker.grantWriteAccessToUsersOrGroups('" + functionPath + "','" + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')", e));
    }
  }
  ...
  public void grantReadAccessToUsersOrGroups(String functionPath, String usersOrGroups, String parameterName, String parameterValue) throws Exception {
    try {
      ...
      throw new Exception(ParseError.parseError(
          "AccessChecker.grantReadAccessToUsersOrGroups('" + functionPath + "','" + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')", e));
    }
  }
  ...
  public void denyWriteAccessToUsersOrGroups(String functionPath, String usersOrGroups, String parameterName, String parameterValue) throws Exception {
    try {
      ...
      throw new Exception(ParseError.parseError(
          "AccessChecker.denyWriteAccessToUsersOrGroups('" + functionPath + "','" + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')", e));
    }
  }
  ...
  public void denyReadAccessToUsersOrGroups(String functionPath, String usersOrGroups, String parameterName, String parameterValue) throws Exception {
    try {
      ...
      throw new Exception(ParseError.parseError(
          "AccessChecker.denyReadAccessToUsersOrGroups('" + functionPath + "','" + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')", e));
    }
  }

  // ********************************************************************************************
  // ** Internal method for establishing access to a function to a list of users
  // and groups **
  // ********************************************************************************************
  /**
   * Establishes access to a function to a list of users and groups. Method used
   * internally.
   * 
   * @param action
   *          Can be <code>"grant"</code> or <code>"deny"</code>. Grants or denies
   *          the access.
   * @param access
   *          Can be <code>"read"</code> or <code>"write"</code>. Specifies the
   *          type of access to establish.
   * @param functionPath
   *          The path to the function the access is granted. Can be on the form
   *          of:
   * 
   ...
   *              <code>parameterValue</code> is.
   * @exception Exception
   *              if <code>action</code> is not one of the allowed values.
   * @exception Exception
   *              if <code>functionName</code> is empty or null.
   * @exception Exception
   *              if <code>usersOrGroups</code> is empty or null.
   * @exception Exception
   *              if <code>usersOrGroups</code> contains undeclared users or
   *              groups.
   */
  public void establishAccessToUsersOrGroups(String action, String access, String functionPath, String usersOrGroups, String parameterName,
    ...
    try {
      ...
      // ........... Locates the access list corresponding to the specified action and
      // access ..........
    ...
    // ******************************************
      ...
      throw new Exception(ParseError.parseError("AccessChecker.establishUserOrGroupAccess('" + action + "','" + functionPath + "','" + usersOrGroups + "','"
  ...
  // ***********************************************************************************************
  /**
   * Checks access to a particular function name. Rules are described in the class
   * documentation {@link AccessChecker}.
   * 
   * @param userName
   *          The user name to check.
   * @param accessType
   *          Can be <code>read</code> or <code>write</code>.
   * @param functionPath
   *          The function name to check. This parameter can be on the form of a
   *          relative path, like:
   * 
   *          <pre>
   *          "userManager/userProfile/userChangePassword"
   ...
   * 
   * @exception If
   *              <code>functionPath</code> is null or empty.
   */
   ...
   *          Can be <code>read</code> or <code>write</code>.
   * @param parameterName
   *          The parameter name to check. If not <code>null</code>, then the
   ...
   *              <code>functionPath</code> is null or empty.
   * @exception If
   *              <code>parameterValue</code> is null or empty but
   *              <code>parameterName</code> is not empty.
   */
  public boolean hasUserAccessTo(String userName, String accessType, String functionPath, String parameterName, String parameterValue) throws Exception {
    try {
      ...
      // ****************************** If the user is not declared, then he has no
      // access *************
      List<String> userGroups = retrieveUserGroups(userName); // Returns the list of groups, and appends the specified user name as one of the
                                                              // groups.
    ...
    // ********************************
      ...
      throw new Exception(ParseError.parseError(
          "AccessChecker.hasUserAccessTo('" + userName + "','" + functionPath + "','" + parameterName + "','" + parameterValue + "')", e));
    }
  }
  ...
  // ******************************************************************************************
  /**
   * Returns the list of groups, and appends the specified user name as one of the
   * groups.
   */
  private List<String> retrieveUserGroups(String userName) throws Exception {
    try {
      ...
      // ................... Initializes a list with the requested user already
      // included ..........
  ...
  private class AccessCheckerElement {
    ...
    /**
     * Default class constructor. Initializes the access lists.
     */
    ...
    /**
     * Checks the user access to the current element. Check is performed as follows:
     * <ul>
     * <li>Only one of the four access list is tested:
     * <ul>
     * <li>If the user <b>has</b> access to the parent element
     * (<code>accessToParent=true</code>, and the requested access type is
     * <code>read</code>, then only {@link #denyReading} is checked.</li>
     * <li>If the user <b>has</b> access to the parent element
     * (<code>accessToParent=true</code>, and the requested access type is
     * <code>write</code>, then only {@link #denyWriting} is checked.</li>
     * <li>If the user <b>has no</b> access to the parent element
     * (<code>accessToParent=false</code>, and the requested access type is
     * <code>read</code>, then only {@link #grantReading} is checked.</li>
     * <li>If the user <b>has no</b> access to the parent element
     * (<code>accessToParent=false</code>, and the requested access type is
     * <code>write</code>, then only {@link #grantWriting} is checked.</li>
     * </ul>
     * </li>
     * <li>If the user, or one of the groups he belongs to (parameter
     * <code>userGroups</code>) is found in the pertinent list, then the value
     * returned by the method is the negated value of
     * <code>accessToParent</code>.</li>
     * <li>If neither the user, or any of the groups he belongs to (parameter
     * <code>userGroups</code>) is found in the pertinent list, then the value
     * returned by the method is directly the value of
     * <code>accessToParent</code>.</li>
     * </ul>
     * 
     * @param accessToParent
     *          Has to be <code>true</code> if the user has access to the parent
     *          element.
     * @param accessType
     *          Can be either <code>"read"</code> or <code>"write"</code>.
     * @param userGroups
     *          A list containing the user name, plus all groups he belongs to.
     * @return <code>true</code> if the user has access to the element,
     *         <code>false</code> otherwise.
     * @throws Exception
     *           If <code>accessType</code> is not <code>"read"</code> or
     *           <code>"write"</code>.
     */
  ...
  // ******************* Additionally, functions can have descendants and
  // parameters **********
  /**
   * Extension of the base class {@link AccessCheckerElement} for describing a
   * function. Functions can have descendants and parameters.
   */
  private class AccessCheckerFunction extends AccessCheckerElement {
    ...
    /**
     * Default class constructor. Initializes an empty function tree, and an empty
  ...
  /**
   * Extension of the base class {@link AccessCheckerElement} for describing a
   * parameter. Functions can have a collection of values.
   */
  private class AccessCheckerParameter extends AccessCheckerElement {
    ...
    private String toString(int level) {
      ...
      Iterator<Map.Entry<String, AccessChecker.AccessCheckerElement>> valuesIterator = values.entrySet()
                                                                                             .iterator();
      while (valuesIterator.hasNext()) {
        Map.Entry<String, AccessCheckerElement> valueEntry = valuesIterator.next();
        ss.append(indent + "<parameter name=\"" + parameterName + "\" " + valueEntry.getValue()
                                                                                    .toString()
