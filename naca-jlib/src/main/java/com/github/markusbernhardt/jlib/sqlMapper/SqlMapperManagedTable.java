...
public class SqlMapperManagedTable {
  ...
  // private Hashtable<String, RecordId> m_hashRecordIdByName = null; // map of
  // all recordId indexed by their names
  ...
  // private synchronized SqlMapperManagedRecord getOrCreateRecordByName(RecordId
  // recordId)
  // {
  ...
  // private synchronized SqlMapperManagedRecord getOrCreateRecord(RecordId
  // recordId)
  // {
  ...
  // }
  // // New record
  // m_hashRecordIdByName.put(recordId.getName(), recordId); // Identifies the
  // recordId by it's name in a map
  //
  ...
  // public synchronized SqlMapperManagedRecord getRecordByRecordId(RecordId
  // recordId)
  // {
  // if(recordId == null)
  // return null;
  ...
  // public synchronized SqlMapperManagedRecord getRecordByName(String
  // csRecordName)
  // {
  ...
  //
  // public synchronized SqlMapperManagedRecord createNewRecordWithId(RecordId
  // recordId)
  // {
