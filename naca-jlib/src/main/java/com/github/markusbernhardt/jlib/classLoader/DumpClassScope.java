 ...
 *         Roubtsov</a>, 2003
 */
public abstract class DumpClassScope {
  // public: ................................................................

  /**
   * Given a class loader instance, returns all classes currently loaded by that
   * class loader.
   * 
   * @param defining
   *          class loader to inspect [may not be null]
   * @return Class array such that every Class has 'loader' as its defining class
   *         loader [never null, may be empty]
   * 
  ...
  /**
   * Returns the class loader set "relevant" to the calling class, as described in
   * the article. Starting with the class that is the caller of this method, it
   * collects all class loaders that are loaders for all classes on the call stack
   * and their respective parent loaders.
   * 
  ...
  /**
   * Given a Class object, attempts to find its .class location [returns null if
   * no such definiton could be found].
   * 
  ...
  static {
    ...
    try {
      ...
      if (tempf.getType() != Vector.class)
        throw new RuntimeException("not of type java.util.Vector: " + tempf.getType()
                                                                           .getName());
