 ...
 * @version $Id: DbColDefinitionVarchar.java,v 1.6 2007/06/08 14:28:18 u930bm
 *          Exp $
 */
public class DbColDefinitionVarchar extends BaseDbColDefinition {
  ...
  // {
  // int nLength = LittleEndingUnsignBinaryBufferStorage.readShort(arrByteValue,
  // nSourceOffset);
  //
  // if(bEbcdicInput) // Must outout in ebcdic
  // AsciiEbcdicConverter.swapByteEbcdicToAscii(arrByteValue, nSourceOffset,
  // m_nLength);
  //
