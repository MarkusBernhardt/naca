 ...
 * one {@link EventError} event, and shortly after a <i>EventAbort</i> (this
 * class) event.</li>
 * <li>If the application encounters an error that will not force it to abort,
 * it should log a {@link EventWarning} event.</li>
 * </ul>
 * This class allows to log the simplest "Abort" event. If you need to join
...
public class EventAbort extends LogEvent {
   ...
   * @param csErrorMessage
   *          The description of the error that forced the application to abort.
   */
  ...
  /**
   * Logs a "Abort" event. For more details about the <i>Product</i> and
   ...
   * 
   * @param csProcess
   *          The name of the Aborting process.
   * @param csProduct
   *          The name of the product (brand, client, source, etc.) about to be
   *          processed. Leave it to <i>null</i> if unknown.
   */
