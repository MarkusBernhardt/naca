  ...
  public void send() {
    try {
      ...
      while (entriesMail.hasMoreElements()) {
        mimeMessage.addRecipient(Message.RecipientType.TO, new InternetAddress((String) entriesMail.nextElement()));
      }

      entriesMail = m_arrCCList.elements();
      while (entriesMail.hasMoreElements()) {
        mimeMessage.addRecipient(Message.RecipientType.CC, new InternetAddress((String) entriesMail.nextElement()));
      }

      entriesMail = m_arrBCCList.elements();
      while (entriesMail.hasMoreElements()) {
        mimeMessage.addRecipient(Message.RecipientType.BCC, new InternetAddress((String) entriesMail.nextElement()));
      }
