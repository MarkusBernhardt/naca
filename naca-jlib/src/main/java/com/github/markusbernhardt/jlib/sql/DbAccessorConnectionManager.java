 ...
 * @version $Id: DbAccessorConnectionManager.java,v 1.6 2008/07/09 06:40:18
 *          u930di Exp $
 */
public class DbAccessorConnectionManager {
  ...
  public static DbConnectionBase getConnection(DbAccessor dbId) throws TechnicalException {
    DbConnectionManagerContext dbConnectionManagerContext = getOrCreateConnectionManagerContext(dbId);
    if (dbConnectionManagerContext != null && dbConnectionManagerContext.isCreated()) {
    ...
    TechnicalException.throwException(TechnicalException.MISSING_CONFIGURATION,
  ...
  /**
   * @param dbId:
   *          DbAccesor whose number of free connections is searched
