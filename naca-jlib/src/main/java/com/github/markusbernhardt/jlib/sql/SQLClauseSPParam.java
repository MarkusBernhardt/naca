...
public abstract class SQLClauseSPParam {
  ...
  void registerIntoCallableStatement(int nParamId, DbPreparedCallableStatement callableStatement, SQLClauseSPParamDesc paramDesc) throws TechnicalException {
    nParamId++; // 1 based
    String csError = null;
    try {
