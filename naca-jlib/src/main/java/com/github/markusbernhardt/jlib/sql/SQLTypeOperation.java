...
public class SQLTypeOperation {
  ...
  private static String addEnvironmentPrefixStandardParser(String env, String csQuery, String csQueryUpper, SQLTypeOperation typeOperation,
      String csForcedReplacedPrefix, boolean bSupportJoin) {
    int nStart = 0;
