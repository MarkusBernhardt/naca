...
/**
 * support class for easy string encryption with the Blowfish algorithm, now in
 * CBC mode with a SHA-1 key setup and correct padding - the purposes of this
 * module is mainly to show a possible implementation with Blowfish ...
 * 
