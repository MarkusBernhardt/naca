...
public class SQLClauseSPCallBase {
  ...
  protected int prepareAndCallWithException(DbConnectionBase connection) throws TechnicalException {
  ...
  private DbPreparedCallableStatement prepareWithException(DbConnectionBase connection) throws TechnicalException {
  ...
  private void registerInOutParameters(DbPreparedCallableStatement callableStatement, SQLClauseSPParamsDesc paramsDesc) throws TechnicalException {
  ...
  private void retrieveOutValuesWithException(DbConnectionBase connection) throws TechnicalException {
    int n = 0;
    try {
      ...
      int n1Based = n + 1;
      TechnicalException.throwException(TechnicalException.STORED_PROC_CALL_RETRIEVE_OUT_VALUES_ERROR, "Parameter:" + n1Based + "; Clause=" + dump(connection),
          e);
    }
  }

  private void closeWithException(DbConnectionBase connection) throws TechnicalException {
    try {
