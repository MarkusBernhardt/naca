...
public class DateUtil {
   ...
   *          sDateFormat
   * @return String sDate
   * @Examples : The following pattern letters are defined (all other characters
   ...
   *           <li>F Day of week in month Number 2</li>
   ...
   *           <li>z Time zone General time zone Pacific Standard Time; PST;
   *           GMT-08:00</li>
   *           <li>Z Time zone RFC 822 time zone -0800</li>
   *           </ul>
   *           <p>
   *           Other examples : The following examples show how date and time
   *           patterns are interpreted in the U.S. locale. The given date and
   *           time are 2001-07-04 12:08:56 local time in the U.S. Pacific Time
   *           time zone.
   *           <p>
   *           Date and Time Pattern Result
   *           <p>
   *           <ul>
   *           <li>"yyyy.MM.dd G 'at' HH:mm:ss z" 2001.07.04 AD at 12:08:56 PDT
   *           </li>
   *           <li>"EEE, MMM d, ''yy" Wed, Jul 4, '01</li>
   *           <li>"h:mm a" 12:08 PM</li>
   *           <li>"hh 'o''clock' a, zzzz" 12 o'clock PM, Pacific Daylight Time
   *           </li>
   *           <li>"K:mm a, z" 0:08 PM, PDT</li>
   *           <li>"yyyyy.MMMMM.dd GGG hh:mm aaa" 02001.July.04 AD 12:08 PM</li>
   *           <li>"EEE, d MMM yyyy HH:mm:ss Z" Wed, 4 Jul 2001 12:08:56 -0700
   *           </li>
   *           <li>"yyMMddHHmmssZ" 010704120856-0700</li>
   *           <li>"yyyy-MM-dd'T'HH:mm:ss.SSSZ" 2001-07-04T12:08:56.235-0700</li>
   *           </ul>
   *           <p>
   *           Synchronization : Date formats are not synchronized. It is
   *           recommended to create separate format instances for each thread. If
   *           multiple threads access a format concurrently, it must be
  ...
  /**
   * Allow to create a text line of a collection of date date apart from an ISO
   * date pattern
   * 
   * @param Collection<Date>
   *          dateColl
   * @param String
   *          sDateFormat - ISO pattern
   * @param String
   *          sSeparator - list separator (e.g. : ' ' or ';')
  ...
  public static Date parseStringToDate(String sDate, String sDateFormat) {
    ...
    if (sDate == null || sDateFormat == null || sDate.length() < sDateFormat.length())
      return null;
  ...
  // *************************************************************************************************
  // ** Function converting a date in String formatted as RCA Date format
  // (YYYY-MM-DDT00:00:00.0Z) **
  // *************************************************************************************************
