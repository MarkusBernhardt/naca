...
/**
 * Declares and registers the <i>Monitoring</i> flow. Events reporting normal
 * application/service activity (like starting, stoping, number of processed
 * elements...) should belong to the <i>Monitoring</i> flow.
 * <p/>
...
public class LogFlowMonitoring extends LogFlow {
  /**
   * Registers the <i>Monitoring</i> flow to the {@link LogFlowRegister}
   * singleton.
   */
  LogFlowMonitoring() {
    super("Monitoring");
