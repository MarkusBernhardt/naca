...
public class FtpException extends Exception {
  ...
  /**
   * Returns the standard exception message. The standard exception message is
   * composed by all available data specified to the constructor:
   * 
   * <pre>
  ...
  /**
   * Contains the specific message (the 'message' parameter specified to the
   * constructor).
   */
  private String _specificMessage;

  /**
   * Returns the specific message (the 'message' parameter specified to the
   * constructor).
   * 
   * @return The specific message (the 'message' parameter specified to the
   *         constructor).
   */
  ...
  /**
   * Returns (if available) the error code returned by the server. Ftp error codes
   * are:
   * <ul>
   * <li><b>110</b>: Restart marker reply. In this case, the text is exact and not
   * left to the particular implementation; it must read: MARK yyyy = mmmm Where
   * yyyy is User-process data stream marker, and mmmm server's equivalent marker
   * (note the spaces between markers and "=").</li>
   ...
   * <li><b>214</b>: Help message. On how to use the server or the meaning of a
   * particular non-standard command. This reply is useful only to the human
   * user.</li>
   * <li><b>215</b>: NAME system type. Where NAME is an official system name from
   * the list in the Assigned Numbers document.</li>
   * <li><b>220</b>: Service ready for new user.</li>
   * <li><b>221</b>: Service closing control connection. Logged out if
   * appropriate.</li>
   * <li><b>225</b>: Data connection open; no transfer in progress.</li>
   * <li><b>226</b>: Closing data connection. Requested file action successful
   * (for example, file transfer or file abort).</li>
   ...
   * <li><b>421</b>: Service not available, closing control connection. This may
   * be a reply to any command if the service knows it must shut down.</li>
   * <li><b>425</b>: Can't open data connection.</li>
   * <li><b>426</b>: Connection closed; transfer aborted.</li>
   * <li><b>450</b>: Requested file action not taken. File unavailable (e.g., file
   * busy).</li>
   * <li><b>451</b>: Requested action aborted: local error in processing.</li>
   * <li><b>452</b>: Requested action not taken. Insufficient storage space in
   * system.</li>
   * <li><b>500</b>: Syntax error, command unrecognized. This may include errors
   * such as command line too long.</li>
   ...
   * <li><b>550</b>: Requested action not taken. File unavailable (e.g., file not
   * found, no access).</li>
   * <li><b>551</b>: Requested action aborted: page type unknown.</li>
   * <li><b>552</b>: Requested file action aborted. Exceeded storage allocation
   * (for current directory or dataset).</li>
  ...
  /**
   * Contains the response returned by the server. The response starts with 3
   * numbers specifying the error code.
   */
   ...
   * 
   * @param message
   *          Specific message describing the circumstances when the error has
   *          been received.
   */
   ...
   *          been received.
   * @param response
   *          The response containing the error returned by the FTP server.
   */
