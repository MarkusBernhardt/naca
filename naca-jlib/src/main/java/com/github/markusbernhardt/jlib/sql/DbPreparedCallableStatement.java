 ...
 * @version $Id: DbPreparedCallableStatement.java,v 1.5 2007/10/17 05:04:27
 *          u930di Exp $
 */
public class DbPreparedCallableStatement {
  ...
  public boolean setInValueWithException(int nParamId, double d) throws SQLException {
    m_callableStatement.setDouble(nParamId, d);
    return true;
  }
  ...
  public boolean setInValueWithException(int nParamId, short s) throws SQLException {
  ...
  public boolean setInValueWithException(int n, String cs) throws SQLException {
  ...
  public String getOutValueStringWithException(int nParamId) throws SQLException {
  ...
  public double getOutValueDoubleWithException(int nParamId) throws SQLException {
  ...
  public int getOutValueIntWithException(int nParamId) throws SQLException {
  ...
  public short getOutValueShortWithException(int nParamId) throws SQLException {
  ...
  public boolean registerOutParameterWithException(int nParamId, int nTypeId) throws SQLException {
  ...
  public boolean executeWithException() throws SQLException {
  ...
  public boolean closeWithException() throws SQLException {
