...
public class BASE64DecoderInputStream extends InputStream {
  ...
  // *************************************************************************
  /**
   * The constructor admits any <code>InputStream</code> connected to a BASE64
   * source.
   * 
   * @param binaryInput
   *          An input connected to a Base64 source.
   */
  ...
  // ***************************** The data input ****************************
  /**
   * Contains the data source. The source is assumed to be base64, so retrieved
   ...
   * retrieved from the base64 encoding, as the number of bytes varies (4 bytes
   * input are 3 bytes output, plus the padding).
   */
