 ...
 */
package com.github.markusbernhardt.jlib.controler;

import java.io.File;
import java.util.Enumeration;
import java.util.Hashtable;

import com.github.markusbernhardt.jlib.log.stdEvents.LoadConfigCompleted;
import com.github.markusbernhardt.jlib.log.stdEvents.LoadConfigError;
import com.github.markusbernhardt.jlib.log.stdEvents.LoadConfigStart;
...
public abstract class BaseControlerConfig {
  ...
  // LoadConfigStart.log(getLogChannel(), m_fConfigFile.getAbsolutePath(), "Start
  // loading from file...") ;
  ...
  // else
  // {
  // LoadConfigError.log(m_fConfigFile.getAbsolutePath(), "Conf loading
  // completed.") ;
  // }
  // }
