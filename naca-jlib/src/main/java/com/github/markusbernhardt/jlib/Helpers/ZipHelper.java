...
/**
 * Class containing helpers for creating ZIP archives from folders, files and
 * list of files.
 */
public class ZipHelper {
  ...
  // **********************************************************************************
  /**
   * Zips the content of the specified folder. The create Zip archive preserves
   * the same structure as the specified folder. If the Zip archive already
   * exists, it is overwritten.
   * 
   * @param sourceFolder
   *          The folder whose content is to be archived.
   * @param destinationZipArchive
   *          The zip archive where to archive the folder content.
   * @param moveFiles
   *          If <i>true</i>, archived files are erased from the source folder.
   *          The source folder itself is not removed.
   */
   ...
   *          The file to archive.
   * @param destinationZipArchive
   *          Specifies the zip archive where to store the specified file. If the
   *          zip archive already exists, it is deleted before starting the
   *          process. Folders and subfolders are created if needed. If the
   *          specified file already exists and it is a folder, an exception is
   *          raised.
   * @param moveFile
   *          If <i>true</i> the specified file is deleted from its original
  ...
  // **********************************************************************************
  /**
   * Zips the specified collection of files. The created Zip archive is flat,
   * without any folder hierarchy. This is an example of use:
   * 
   * <pre>
   ...
   * 
   * @param files
   *          The list of files to add to the zip archive. Entries in the list can
   *          be either {@link String} containing full paths to the files, or
   *          {@link File} objects. Any other class raise an exception. All files
   *          have to exist, and can't be folders (an exception is raised in
   *          either case).
   * @param destinationZipArchive
   *          Specifies the zip archive where to store the files specified in the
   *          list. If the zip archive already exists, it is deleted before
   *          starting the process. Folders and subfolders are created if needed.
   *          If the specified file already exists and it is a folder, an
   *          exception is raised.
   * @param moveFiles
   *          If <i>true</i> the specified files are deleted from their original
   *          location after the zip archive has been successfully created. No
   *          file is deleted before the zip archive is completed.
   */
