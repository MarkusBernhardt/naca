...
public class ArrayDbConnectionPool {
  ...
  private int aggressiveRemoveObsoleteStatements(MemoryPoolMXBean tenuredPool, SortedMap<Long, StatementPosInPool> mapStatements, int nNbStatementForcedRemoved,
      int nNbSystemGCCall) {
