...
/**
 * An OutputStream that encrypts data using the Blowfish algorithm. 30 Mar 2002,
 * fixed bug in flush method
 * 
...
public class BlowfishOutputStream extends OutputStream {
   ...
   * written is the eight low-order bits of the argument b. The 24 high-order bits
   * of b are ignored.
   * 
   * @param b
   *          the byte to write
  ...
  public void close() throws IOException {
    ...
    // Minor correction: 8 isn't the magic number, rather it's
