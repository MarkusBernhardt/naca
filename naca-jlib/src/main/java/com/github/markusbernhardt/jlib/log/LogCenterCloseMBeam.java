...
public abstract class LogCenterCloseMBeam extends BaseCloseMBean {
  ...
  protected void buildDynamicMBeanInfo() {
    ...
    // addOperation("Enable", "Enable logger", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Critical", "Critical level", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Important", "Important level", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Normal", "Normal level", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Verbose", "Verbose level", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Debug", "Debug level", params, "void",
    // MBeanOperationInfo.ACTION);
    // addOperation("Fine Debug", "Fine Debug level", params, "void",
    // MBeanOperationInfo.ACTION);
    //
    // dNotifications[0] =
