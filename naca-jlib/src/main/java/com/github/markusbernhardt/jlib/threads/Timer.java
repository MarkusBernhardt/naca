...
/*
 * public class MyTimer extends Timer { private Caller m_c = null;
 * MyTimer(Caller c) { m_c = c; }
 * 
 * protected boolean pulse() { return m_c.onTimerPulse(); } }
 * 
 * // Caller code in class Caller
 * 
 * class Caller { ... void launchTimer() { ... MyTimer timer = new
 * MyTimer(this); timer.startTimer(60000); // Pulse every minute ... }
 * 
 * public boolean onTimerPulse() // Executed in the context of the timer thread
 * { // Do actions ... return true; }
 * 
 */
