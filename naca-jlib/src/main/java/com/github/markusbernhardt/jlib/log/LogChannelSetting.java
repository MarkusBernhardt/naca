...
/**
 * Class containing the default settings for one channel. The default settings
 * are merged with the event settings before sending the event to the
 * {@link LogCenter}.
 */
public class LogChannelSetting {
   ...
   * 
   * @param csRunId
   *          Default <i>RunId</i> to be used if events sent to a channel have no
   *          <i>RunId</i> specified.
   * @see {@link Log} for a discussion about the meaning of the <i>RunId</i>,
   *      <i>RuntimeId</i>, and <i>Product</i> identifiers.
   */
   ...
   * 
   * @param csRuntimeId
   *          Default <i>RuntimeId</i> to be used if events sent to a channel have
   *          no <i>RuntimeId</i> specified.
   * @see {@link Log} for a discussion about the meaning of the <i>RunId</i>,
   *      <i>RuntimeId</i>, and <i>Product</i> identifiers.
   */
   ...
   * 
   * @param csProduct
   *          The default <i>Product</i> identifier for the channel.
   * @see {@link Log} for a discussion about the meaning of the <i>RunId</i>,
   *      <i>RuntimeId</i>, and <i>Product</i> identifiers.
   */
