...
// sample call to convert a ArrayList<MBeanOperationInfo> to a
// MBeanOperationInfo[]
// ArrayList<MBeanOperationInfo> arrMBeanOperationInfos = ...
// GenericToArray<MBeanOperationInfo> g = new
// GenericToArray<MBeanOperationInfo>(arrMBeanOperationInfos);
