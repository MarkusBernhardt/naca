...
import com.github.markusbernhardt.jlib.jmxMBean.JmxClassPath;
...
public class PropertyLoader {
  ...
  public String getProperty(String csName) throws TechnicalException {
  ...
  public static String getPropertyWithContext(Object context, String csName) throws TechnicalException {
    try {
  ...
  // **********************************************************************************
  /**
   * Returns the URL to the properties file. This method is normally used
   * internally by the other methods of the class. The file has to be in the
   * standard {@link Properties} format.
   * 
   * @param context
   *          A pointer to the class requesting the properties file. If the
   *          parameter is left to null, the context will be the
   *          {@link PropertyLoader} instance itself.
   * @return The content of the properties file.
   */
  private static Properties getProperties(Object context) throws TechnicalException {
  ...
  // }
  /**
   * Returns an {@link Properties} instance initialized with the content of the
   * specified properties file. The file has to be in the standard
   * {@link Properties} format.
   * 
   * @param context
   *          A pointer to the class requesting the properties file.
   * @param propertiesFileName
   *          The properties file name. If left empty, the default filename is
   *          "app.properties".
   * @return The content of the properties file.
   */
  public static Properties getProperties(Object context, String propertiesFileName) throws TechnicalException {
    ...
    if (ms_properties == null) {
      ...
      // If context is not known, or nothing has been found in the class resources
      // collection:
      if (is == null)
        is = context.getClass()
                    .getClassLoader()
  ...
  /**
   * Returns a <code>InputStream</code> initialized on the specified properties
   * file. This method (in opposite to {@link #getProperties()}, allows to use any
   * format for the properties file.
   * 
   * @param context
   *          A pointer to the class requesting the properties file.
   * @param propertiesFileName
   ...
   *           If the specified properties file is not found in the application's
   *           class path.
   */
  public static InputStream getInputStream(Object context, String propertiesFileName) throws TechnicalException {
    // ..................... Searches for the properties file
    // ...........................
    InputStream is = null;
    if (context == null)
