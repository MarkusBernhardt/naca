 ...
 * creates a new instance of {@link LogCenter}, and registers it to the
 * {@link Log} static collection.
 * 
 * @author PJD
 */
public class LogCenterLoader {
  ...
  /**
   * Reads a <i>LogCenter</i> tag, and instantiates, initializes and registers the
   * corresponding {@link LogCenter} to the {@link Log} static collection.
   * 
   * @param tagLogCenter
   *          The JLib.log xml configuration file should be read with a
   *          {@link Tag} object. Then the <i>LogCenter</i> tag should be located,
   *          and provided here.
