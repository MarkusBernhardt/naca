...
/**
 * 
 * @author U930DAN Cette classe permet de supprimer dans un fichier tout ce qui
 *         est contenu entre les tags < et > par exemple si on soumet le contenu
 *         suivant: <?xml version="1.0" encoding="ISO-8859-1"?>
 *         <pic_1 FileName="t0014395.jpg">Hello</pic_1> en output on obtiendra:
 *         Hello
 */
public class TagRemoverInputStream extends InputStream {
  ...
  // *************************************************************************
  /**
   * Remove xml tag from the provided input source (see
   * {@link #TagRemoverInputStream(InputStream)}
   */
  @Override
