...
import com.github.markusbernhardt.jlib.misc.JSon;
import com.github.markusbernhardt.jlib.misc.JSonParser;
...
public class PagingInfo {
  ...
  public PagingInfo() {
    ...
    _firstItem = 0;
    _lastItem = 0;
    _totalItems = -1; // the number of item containing in the DB without filters.(used only to show it
