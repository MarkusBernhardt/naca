...
public abstract class BaseOpenMBean extends BaseDynamicMBean // implements DynamicMBean
{
  ...
  public Object invoke(String csOperationName, Object params[], String signature[]) {
    ...
    // for(int n=0; n<m_arrOpenMBeanAttributeInfosWrapper.size(); n++)
    // {
    // OpenMBeanAttributeInfoWrapper operationInfoWrapper =
    // m_arrOpenMBeanAttributeInfosWrapper.get(n);
    // OpenMBeanAttributeInfo operationInfo = operationInfoWrapper.getOperation();
    // if(operationInfo.getName().equalsIgnoreCase(csOperationName)) // Found
    // attribut
    // {
    // // Call method
