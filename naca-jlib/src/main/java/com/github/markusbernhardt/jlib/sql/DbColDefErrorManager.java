...
public class DbColDefErrorManager {
  ...
  void reportTruncationError(long lOriginalValue, long lValue, String csColName) {
    ...
    int nLine = m_nLine + 1;
    m_sb.append(
        "Truncation error at file line " + nLine + " For column=" + csColName + " : Original Value=" + lOriginalValue + " Truncated to=" + lValue + "\r\n");
  }
  ...
  void reportTruncationError(String csOriginalValue, String csValue, String csColName) {
    ...
    int nLine = m_nLine + 1;
    m_sb.append(
        "Truncation error at file line " + nLine + " For column=" + csColName + " : Original Value=" + csOriginalValue + " Truncated to=" + csValue + "\r\n");
  }
