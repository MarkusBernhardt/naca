...
public class SqlMapper {
  ...
  // public String getAsString(SqlMapperManagedTable managedTable, RecordId
  // recordId, String csColName)
  // {
  // return managedTable.getAsString(recordId, csColName);
  // }
  //
  // public int getAsInt(SqlMapperManagedTable managedTable, RecordId recordId,
  // String csColName)
  // {
  // return managedTable.getAsInt(recordId, csColName);
  // }
  //
  // public double getAsDouble(SqlMapperManagedTable managedTable, RecordId
  // recordId, String csColName)
  // {
  // return managedTable.getAsDouble(recordId, csColName);
  // }

  // public boolean isSet(SqlMapperManagedTable managedTable, RecordId recordId,
  // String csColName)
  // {
  // return managedTable.isSet(recordId, csColName);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, String csValue)
  // {
  // managedTable.set(recordId, csColName, csValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, int nValue)
  // {
  // managedTable.set(recordId, csColName, nValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, double dValue)
  // {
  // managedTable.set(recordId, csColName, dValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, boolean bValue)
  // {
  // managedTable.set(recordId, csColName, bValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, BigDecimal bdValue)
  // {
  // managedTable.set(recordId, csColName, bdValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, Date dtValue)
  // {
  // managedTable.set(recordId, csColName, dtValue);
  // }
  //
  // public void set(SqlMapperManagedTable managedTable, RecordId recordId, String
  // csColName, Timestamp tsValue)
  // {
  ...
  // public SqlMapperManagedRecord getRecordByName(SqlMapperManagedTable
  // managedTable, String csRecordName)
  // {
  // if(managedTable == null)
  // return null;
  //
  ...
  // }
  //
  // public RecordId getRecordIdByName(SqlMapperManagedTable managedTable, String
  // csRecordName)
  // {
  // if(managedTable == null)
  // return null;
  ...
  // public RecordId getRecordId(SqlMapperManagedTable table, String
  // csRecordIdSemantic)
  // {
  ...
  public void executeInserts(DbAccessor dbAccessor) {
    ...
    for (int nTable = 0; nTable < m_arrTables.size(); nTable++) // A recordId may concern multiple tables; enum all tables that are potential
                                                                // concerned by a record Id
    {
  ...
  // Execute all select statements for all tables on all records; They are done by
  // keys defined in all RecordId
  public void executeSelects(DbAccessor dbAccessor) {
    // Select records for all tables; The select "where" is given by the values
    // stored in the recordId
    for (int nTable = 0; nTable < m_arrTables.size(); nTable++) // A recordId may concern multiple tables; enum all tables that are potential
                                                                // concerned by a record Id
    {
      SqlMapperManagedTable managedTable = m_arrTables.get(nTable);
  ...
  // Execute all delete statements for all tables on all records; They are done by
  // keys defined in all RecordId
  public void executeDeletes(DbAccessor dbAccessor) {
    // Delete records for all tables; The select "where" is given by the values
    // stored in the recordId
    for (int nTable = 0; nTable < m_arrTables.size(); nTable++) // A recordId may concern multiple tables; enum all tables that are potential
                                                                // concerned by a record Id
    {
