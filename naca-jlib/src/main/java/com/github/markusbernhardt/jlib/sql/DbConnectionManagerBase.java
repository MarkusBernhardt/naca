...
import com.github.markusbernhardt.jlib.misc.ListCoupleRender;
...
public abstract class DbConnectionManagerBase {
  ...
  public abstract DbConnectionBase createConnection(Connection connection, String csPrefId, String csEnvironment, boolean bUseStatementCache, boolean bUseJmx,
      DbDriverId dbDriver);
  ...
  public boolean initDB2(String csUrl, String csUser, String csPassword, String csConnectionUrlOptionalParams, int nNbMaxConnections,
      int nTimeBeforeRemoveConnection_ms, int nMaxStatementLiveTime_ms, int nGarbageCollectorStatement_ms) {
    String csDriverClass = "com.ibm.db2.jcc.DB2Driver";
    return initDriverClass(csUrl, csUser, csPassword, csDriverClass, csConnectionUrlOptionalParams, nNbMaxConnections, nTimeBeforeRemoveConnection_ms,
        nMaxStatementLiveTime_ms, nGarbageCollectorStatement_ms);
  }

  public boolean initOracle(String csUrl, String csUser, String csPassword, String csConnectionUrlOptionalParams, int nNbMaxConnections,
      int nTimeBeforeRemoveConnection_ms, int nMaxStatementLiveTime_ms, int nGarbageCollectorStatement_ms) {
  ...
  public boolean initMySql(String csUrl, String csUser, String csPassword, String csConnectionUrlOptionalParams, int nNbMaxConnections,
      int nTimeBeforeRemoveConnection_ms, int nMaxStatementLiveTime_ms, int nGarbageCollectorStatement_ms) {
  ...
  public boolean initSqlServer(String csUrl, String csUser, String csPassword, String csConnectionUrlOptionalParams, int nNbMaxConnections,
      int nTimeBeforeRemoveConnection_ms, int nMaxStatementLiveTime_ms, int nGarbageCollectorStatement_ms) {
  ...
  public boolean initDriverClass(String csUrl, String csUser, String csPassword, String csDriverClass, String csConnectionUrlOptionalParams,
      int nNbMaxConnections, int nTimeBeforeRemoveConnection_ms, int nMaxStatementLiveTime_ms, int nGarbageCollectorStatement_ms) {
    ...
    if (b)
      m_SQLConnectionPool = new DbConnectionPool("UnknownPoolName", nNbMaxConnections, nTimeBeforeRemoveConnection_ms, nMaxStatementLiveTime_ms,
  ...
  protected boolean createDriver(String csDriverClass, String csUser, String csPassword, String csConnectionUrlOptionalParams) {
    ...
    try {
      m_DbConnectionParam.m_driver = (java.sql.Driver) Class.forName(csDriverClass)
                                                            .newInstance();
    ...
    // if(m_DbConnectionParam.m_driver == null)
    // Log.logImportant("Could not create driver " + csDriverClass + " for user " +
    // csUser);
    return true;
  }
  ...
  protected boolean createDriver(String csDriverClass, String csUser, String csCryptedPassword, String csCryptKey, String csConnectionUrlOptionalParams) {
    ...
    try {
      ...
      String csParams = ListCoupleRender.set("Parameters: ")
                                        .set("DriverClass", csDriverClass)
                                        .set("User", csUser)
                                        .set("CryptedPassword", csCryptedPassword)
                                        .toString();
  ...
  public boolean create(String csDBUser, String csDBPassword, String csDBUrl, String csDBProvider, int nNbMaxConnections, int nTimeBeforeRemoveConnection_ms,
    ...
    if (b) {
      // Log.logNormal("Created DB driver " + csDriverClass + " for user " + csDBUser
      // + " on url "+csDBUrl);
    ...
    // else
    // Log.logImportant("Could not create DB driver " + csDriverClass + " for user "
    // + csDBUser + " on url "+csDBUrl);
