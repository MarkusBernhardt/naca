...
import com.github.markusbernhardt.jlib.sql.ColValue;
import com.github.markusbernhardt.jlib.sql.ColValueCollection;
 ...
 * @version $Id: SqlMapperManagedRecord.java,v 1.8 2007/12/04 14:00:23 u930di
 *          Exp $
 */
...
public class SqlMapperManagedRecord extends ColValueCollection {
  ...
  boolean executeDelete(DbAccessor dbAccessor, String csTableName, RecordId recordId) throws TechnicalException {
    SQLClause clause = new SQLClause(dbAccessor);
    try {
  ...
  // public void fillObject(Object oTarget) // Fill the members of the object in
  // parameter
  // {
  ...
  // String csMember = field.getName(); // By convention, the csMember name must
  ...
  // if(colValue == null) // Not found; maybe the member used m_<typing> prefix;
  // try without this prefix
  // {
  // String csUnprefixedMemberName = StringUtil.getUnprefixedMemberName(csMember,
  // "m_", fieldType); //
