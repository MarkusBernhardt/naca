...
import com.github.markusbernhardt.jlib.log.stdEvents.StdInfo;
...
public class ControlerThread extends Thread {
  ...
  // ..............................................................................................................
  /*
   * M�thode principale du thread. Cette m�thode v�rifie l'�tat dans lequel se
   * trouve le crawling et agit en cons�quence.
   */
  public void run() {
  ...
  private void doRun() {
    ...
    while (bContinue) {
      ...
      while (bContinue && nSite < m_grpConfig.getNbSteps()) {
        ...
        /*
         * if (m_nCurrentSite < m_grpConfig.getNbSteps()) { Date nextDate = new Date(new
         * Date().getTime() + m_grpConfig.getStep(m_nCurrentSite +
         * 1).getDelayBeforeRestart() * 1000); m_Controler.setStartDate(m_nCurrentSite +
         * 1, nextDate); }
         */
