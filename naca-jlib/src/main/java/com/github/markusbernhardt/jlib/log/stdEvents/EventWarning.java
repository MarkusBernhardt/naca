 ...
 * </ul>
 * This class allows to log a simple "Warning". You'll probably need to extend
...
public class EventWarning extends LogEvent {
   ...
   * @param csProcess
   *          The name of the process where the "Warning" has been done. If left
   ...
   *          Warning refers. If left <i>null</i> the {@link LogCenter} accepting
  ...
  /**
   * Logs a "Warning" event. For more details about the <i>Product</i> and
   ...
   * 
   * @param csProcess
   *          The name of the process where the "Warning" has found.
   * @param csProduct
   *          The name of the product (brand, client, source, etc.) to which the
   *          Warning refers. "Warning" events aren't usually associated to an
