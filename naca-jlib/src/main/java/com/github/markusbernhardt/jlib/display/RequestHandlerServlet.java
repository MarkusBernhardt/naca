...
public class RequestHandlerServlet extends HttpServlet {
   ...
   * "Submit Form" button. Upon pressing the button, the form gets submitted. The
   * Servlet uses getParameter() method to get the user name entered by the user
   * and displays it in the HTML page. The parameters to doGet() method is 1)
   * HttpServletRequest object, which encapsulates the data from the client 2)
