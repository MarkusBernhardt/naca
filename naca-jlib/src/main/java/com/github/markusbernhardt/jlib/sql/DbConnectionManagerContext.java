...
import com.github.markusbernhardt.jlib.Helpers.PropertyLoader;
 ...
 * @vers ion $Id: DbConnectionManagerContext.java,v 1.9 2008/07/09 06:40:18
 *       u930di Exp $
 */
public class DbConnectionManagerContext {
  ...
  public boolean create(String csPropertyPrefix) throws TechnicalException {
  ...
  public boolean create(String csDBProvider, String csUrl, String csUser, String csPassword, String csEnvironment) throws TechnicalException {
  ...
  private boolean doCreateConnection(String csPropertyPrefix) throws TechnicalException {
    m_dbConnectionManager = new DbConnectionManager();
    m_dbConnectionManager.setPropertyPrefix(csPropertyPrefix);
    try {
      m_bCreated = m_dbConnectionManager.create(m_csDBUser, m_csDBPassword, m_csDBUrl, m_csDBProvider, m_nNbMaxConnections, m_nTimeBeforeRemoveConnection_ms,
