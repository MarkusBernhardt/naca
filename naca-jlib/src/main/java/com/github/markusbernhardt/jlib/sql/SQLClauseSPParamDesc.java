...
public class SQLClauseSPParamDesc extends StoredProcParamDescBase {
  // public void retrieveOutValues(int nParamId, PreparedCallableStatement
  // callableStatement, CSQLStatus sqlStatus)
  // {
  // nParamId++; // 1 based
  // if(m_sColType == DatabaseMetaData.procedureColumnOut || m_sColType ==
  ...
  // Log.logImportant("Catched SQLException from stored procedure
  // retrieveOutValues: "+csReason + " State="+csState);
