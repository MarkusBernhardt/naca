...
/**
 * Notifies all programming exceptions detected during a processing. A
 * programming exception is any abnormal condition detected during a process.
 * <p/>
 * 
 * As opposite to {@link TechnicalException}, a <i>programming error</i>, is
 * communicating to the calling system that currently the requested operation
 * cannot be achieved, and won't succeed in the future until the application is
 * corrected.
 * <p/>
 * 
 * The programming exception are raised as {@link RuntimeException} to avoid
